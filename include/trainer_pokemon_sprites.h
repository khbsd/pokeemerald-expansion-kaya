...
u32 CreateMonPicSprite_Affine(u32 species, bool32 isShiny, u32 personality, u8 flags, s16 x, s16 y, u8 paletteSlot, u32 paletteTag);
u32 CreateMonPicSprite(u32 species, bool32 isShiny, u32 personality, bool32 isFrontPic, s16 x, s16 y, u8 paletteSlot, u32 paletteTag);
u32 FreeAndDestroyMonPicSprite(u32 spriteId);
u32 FreeAndDestroyMonPicSpriteNoPalette(u32 spriteId);
u32 CreateTrainerPicSprite(u32 species, bool32 isFrontPic, s16 x, s16 y, u8 paletteSlot, u32 paletteTag);
