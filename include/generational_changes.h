...
static const u16 sGenerationalChanges[GEN_CONFIG_COUNT] =
{
    ...
    [GEN_CONFIG_POWDER_STATUS_HEAVY_RAIN]  = B_POWDER_STATUS_HEAVY_RAIN,
    ...
    [GEN_CONFIG_FOCUS_PUNCH_FAILURE]       = B_FOCUS_PUNCH_FAILURE,
    [GEN_CONFIG_SANDSTORM_SOLAR_BEAM]      = B_SANDSTORM_SOLAR_BEAM,
    [CONFIG_EXPLOSION_DEFENSE]             = B_EXPLOSION_DEFENSE,
};
