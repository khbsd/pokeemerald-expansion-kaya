...
void DisplayMessageAndContinueTask(u8 taskId, u8 windowId, u32 tileNum, u8 paletteNum, u8 fontId, u8 textSpeed, const u8 *string, void *taskFunc);
...
bool8 AdjustQuantityAccordingToDPadInput(s16 *quantity, u32 max);
u8 GetLRKeysPressed(void);
u8 GetLRKeysPressedAndHeld(void);
bool8 IsHoldingItemAllowed(u32 itemId);
bool8 IsWritingMailAllowed(u32 itemId);
...
void SetCursorWithinListBounds(u32 *scrollOffset, u32 *cursorPos, u8 maxShownItems, u8 totalItems);
void SetCursorScrollWithinListBounds(u32 *scrollOffset, u32 *cursorPos, u8 shownItems, u8 totalItems, u8 maxShownItems);
