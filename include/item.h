...
bool8 CheckBagHasItem(u32 itemId, u32 count);
bool8 HasAtLeastOneBerry(void);
bool8 HasAtLeastOnePokeBall(void);
bool8 CheckBagHasSpace(u32 itemId, u32 count);
u32 GetFreeSpaceForItemInBag(u32 itemId);
bool8 AddBagItem(u32 itemId, u32 count);
bool8 RemoveBagItem(u32 itemId, u32 count);
u8 GetPocketByItemId(u32 itemId);
void ClearItemSlots(struct ItemSlot *itemSlots, u8 itemCount);
u8 CountUsedPCItemSlots(void);
bool8 CheckPCHasItem(u32 itemId, u32 count);
bool8 AddPCItem(u32 itemId, u32 count);
...
bool8 AddPyramidBagItem(u32 itemId, u32 count);
bool8 RemovePyramidBagItem(u32 itemId, u32 count);
