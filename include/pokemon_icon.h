...
u8 CreateMonIconNoPersonality(u32 species, void (*callback)(struct Sprite *), s32 x, s32 y, u8 subpriority);
void FreeMonIconPalette(u32 species);
void FreeAndDestroyMonIconSprite(struct Sprite *sprite);
u8 CreateMonIcon(u32 species, void (*callback)(struct Sprite *), s32 x, s32 y, u8 subpriority, u32 personality);
