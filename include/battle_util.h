...
enum MoveAbsorbed
{
    ...
    MOVE_ABSORBED_BY_BOOST_STEAM_ENGINE,
};
...
bool32 CanBeBurned(u32 battlerAtk, u32 battlerDef, enum Abilities ability);
...
bool32 CanSetNonVolatileStatus(u32 battlerAtk, u32 battlerDef, enum Abilities abilityAtk, enum Abilities abilityDef, enum MoveEffects secondaryMoveEffect, enum FunctionCallOption option);
