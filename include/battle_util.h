...
u8 CheckMoveLimitations(u32 battler, u8 unusableMoves, u32 check);
bool32 AreAllMovesUnusable(u32 battler);
u8 GetImprisonedMovesCount(u32 battler, u32 move);
...
bool32 ShouldGetStatBadgeBoost(u32 flagId, u32 battler);
