...
bool32 ScriptMenu_MultichoiceDynamic(u8 left, u8 top, u8 argc, struct ListMenuItem *items, bool32 ignoreBPress, u8 maxBeforeScroll, u32 initialRow, u32 callbackSet);
bool32 ScriptMenu_Multichoice(u8 left, u8 top, u8 multichoiceId, bool32 ignoreBPress);
bool32 ScriptMenu_MultichoiceWithDefault(u8 left, u8 top, u8 multichoiceId, bool32 ignoreBPress, u8 defaultChoice);
void DrawMultichoiceMenuInternal(u8 left, u8 top, u8 multichoiceId, bool32 ignoreBPress, u8 cursorPos, const struct MenuAction *actions, int count);
bool32 ScriptMenu_YesNo(u8 left, u8 top);
bool32 ScriptMenu_MultichoiceGrid(u8 left, u8 top, u8 multichoiceId, bool32 ignoreBPress, u8 columnCount);
