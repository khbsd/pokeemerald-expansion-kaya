...
enum MetatileBehaviors
{
    ...
    MB_DEOXYS_FORM_CHANGE_NORMAL,
    MB_DEOXYS_FORM_CHANGE_ATTACK,
    MB_DEOXYS_FORM_CHANGE_DEFENSE,
    MB_DEOXYS_FORM_CHANGE_SPEED,
    MB_IMPASSABLE_EAST,
    MB_IMPASSABLE_WEST,
    MB_IMPASSABLE_NORTH,
    MB_IMPASSABLE_SOUTH,
    ...
    MB_TALL_GRASS_2,
    MB_TALL_GRASS_3,
    MB_INDOOR_ENCOUNTER_2,
    MB_INDOOR_ENCOUNTER_3,
    MB_CAVE_2,
    MB_CAVE_3,
    MB_PUDDLE_2,
    MB_PUDDLE_3,
    ...
    MB_COUNTER,
    MB_SEAWEED_NO_SURFACING_2,
    MB_SEAWEED_NO_SURFACING_3,
    MB_PC,
