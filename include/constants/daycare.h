...
// step cycle values
#define DAYCARE_STEPS_MAX   511    // the max a stepcounter in any gen will be is 257, so we need 9 bits to capture a number that high
#define DAYCARE_STEPS_GEN1  256
#define DAYCARE_STEPS_GEN4  255
#define DAYCARE_STEPS_GEN5  257
#define DAYCARE_STEPS_GEN8  128
