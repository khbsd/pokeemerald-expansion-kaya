...
#define BATTLE_CONFIG_DEFINITIONS(F) \
    ...
    F(B_PROTEAN_LIBERO_GAUCHO,     proteanLiberoGauchoPants,(u32, GEN_COUNT - 1)) \
    ...
    F(B_BADGE_CATCH_BOOST,         badgeCatchBoost,         (u32, TRUE)) \
...
#define POKEMON_CONFIG_DEFINITIONS(F) \
    F(P_POKERUS_ENABLED,              pokerusEnabled,          (u32, TRUE))          \
    F(P_POKERUS_SPREAD_ADJACENCY,     pokerusSpreadAdjacency,  (u32, GEN_COUNT - 1)) \
    F(P_POKERUS_SPREAD_DAYS_LEFT,     pokerusSpreadDaysLeft,   (u32, GEN_COUNT - 1)) \
    F(P_POKERUS_INFECT_AGAIN,         pokerusInfectAgain,      (u32, GEN_COUNT - 1)) \
    F(P_POKERUS_INFECT_EGG,           pokerusInfectEgg,        (u32, TRUE))          \
    F(P_POKERUS_HERD_IMMUNITY,        pokerusHerdImmunity,     (u32, TRUE))          \
    F(P_POKERUS_WEAK_VARIANT,         pokerusWeakVariant,      (u32, TRUE))          \
