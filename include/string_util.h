...
u32 StringLength(const u8 *str);
u32 StringLineLength(const u8 *str);
...
u8 *StringFill(u8 *dest, u8 c, u32 n);
u8 *StringCopyPadded(u8 *dest, const u8 *src, u8 c, u32 n);
u8 *StringFillWithTerminator(u8 *dest, u32 n);
