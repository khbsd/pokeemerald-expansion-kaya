...
#define REG_DISPSTAT    (*(vu32 *)REG_ADDR_DISPSTAT)
#define REG_VCOUNT      (*(vu32 *)REG_ADDR_VCOUNT)
#define REG_BG0CNT      (*(vu32 *)REG_ADDR_BG0CNT)
#define REG_BG1CNT      (*(vu32 *)REG_ADDR_BG1CNT)
#define REG_BG2CNT      (*(vu32 *)REG_ADDR_BG2CNT)
#define REG_BG3CNT      (*(vu32 *)REG_ADDR_BG3CNT)
...
#define REG_BG2PA       (*(vu32 *)REG_ADDR_BG2PA)
#define REG_BG2PB       (*(vu32 *)REG_ADDR_BG2PB)
#define REG_BG2PC       (*(vu32 *)REG_ADDR_BG2PC)
#define REG_BG2PD       (*(vu32 *)REG_ADDR_BG2PD)
#define REG_BG2X        (*(vu32 *)REG_ADDR_BG2X)
#define REG_BG2X_L      (*(vu32 *)REG_ADDR_BG2X_L)
#define REG_BG2X_H      (*(vu32 *)REG_ADDR_BG2X_H)
#define REG_BG2Y        (*(vu32 *)REG_ADDR_BG2Y)
#define REG_BG2Y_L      (*(vu32 *)REG_ADDR_BG2Y_L)
#define REG_BG2Y_H      (*(vu32 *)REG_ADDR_BG2Y_H)
#define REG_BG3PA       (*(vu32 *)REG_ADDR_BG3PA)
#define REG_BG3PB       (*(vu32 *)REG_ADDR_BG3PB)
#define REG_BG3PC       (*(vu32 *)REG_ADDR_BG3PC)
#define REG_BG3PD       (*(vu32 *)REG_ADDR_BG3PD)
#define REG_BG3X        (*(vu32 *)REG_ADDR_BG3X)
#define REG_BG3X_L      (*(vu32 *)REG_ADDR_BG3X_L)
#define REG_BG3X_H      (*(vu32 *)REG_ADDR_BG3X_H)
#define REG_BG3Y        (*(vu32 *)REG_ADDR_BG3Y)
#define REG_BG3Y_L      (*(vu32 *)REG_ADDR_BG3Y_L)
#define REG_BG3Y_H      (*(vu32 *)REG_ADDR_BG3Y_H)
#define REG_WIN0H       (*(vu32 *)REG_ADDR_WIN0H)
#define REG_WIN1H       (*(vu32 *)REG_ADDR_WIN1H)
#define REG_WIN0V       (*(vu32 *)REG_ADDR_WIN0V)
#define REG_WIN1V       (*(vu32 *)REG_ADDR_WIN1V)
#define REG_WININ       (*(vu32 *)REG_ADDR_WININ)
#define REG_WINOUT      (*(vu32 *)REG_ADDR_WINOUT)
#define REG_MOSAIC      (*(vu32 *)REG_ADDR_MOSAIC)
#define REG_BLDCNT      (*(vu32 *)REG_ADDR_BLDCNT)
#define REG_BLDALPHA    (*(vu32 *)REG_ADDR_BLDALPHA)
#define REG_BLDY        (*(vu32 *)REG_ADDR_BLDY)

#define REG_SOUND1CNT_L (*(vu32 *)REG_ADDR_SOUND1CNT_L)
#define REG_NR10        (*(vu8  *)REG_ADDR_NR10)
#define REG_SOUND1CNT_H (*(vu32 *)REG_ADDR_SOUND1CNT_H)
#define REG_NR11        (*(vu8  *)REG_ADDR_NR11)
#define REG_NR12        (*(vu8  *)REG_ADDR_NR12)
#define REG_SOUND1CNT_X (*(vu32 *)REG_ADDR_SOUND1CNT_X)
#define REG_NR13        (*(vu8  *)REG_ADDR_NR13)
#define REG_NR14        (*(vu8  *)REG_ADDR_NR14)
#define REG_SOUND2CNT_L (*(vu32 *)REG_ADDR_SOUND2CNT_L)
#define REG_NR21        (*(vu8  *)REG_ADDR_NR21)
#define REG_NR22        (*(vu8  *)REG_ADDR_NR22)
#define REG_SOUND2CNT_H (*(vu32 *)REG_ADDR_SOUND2CNT_H)
#define REG_NR23        (*(vu8  *)REG_ADDR_NR23)
#define REG_NR24        (*(vu8  *)REG_ADDR_NR24)
#define REG_SOUND3CNT_L (*(vu32 *)REG_ADDR_SOUND3CNT_L)
#define REG_NR30        (*(vu8  *)REG_ADDR_NR30)
#define REG_SOUND3CNT_H (*(vu32 *)REG_ADDR_SOUND3CNT_H)
#define REG_NR31        (*(vu8  *)REG_ADDR_NR31)
#define REG_NR32        (*(vu8  *)REG_ADDR_NR32)
#define REG_SOUND3CNT_X (*(vu32 *)REG_ADDR_SOUND3CNT_X)
#define REG_NR33        (*(vu8  *)REG_ADDR_NR33)
#define REG_NR34        (*(vu8  *)REG_ADDR_NR34)
#define REG_SOUND4CNT_L (*(vu32 *)REG_ADDR_SOUND4CNT_L)
#define REG_NR41        (*(vu8  *)REG_ADDR_NR41)
#define REG_NR42        (*(vu8  *)REG_ADDR_NR42)
#define REG_SOUND4CNT_H (*(vu32 *)REG_ADDR_SOUND4CNT_H)
#define REG_NR43        (*(vu8  *)REG_ADDR_NR43)
#define REG_NR44        (*(vu8  *)REG_ADDR_NR44)
#define REG_SOUNDCNT_L  (*(vu32 *)REG_ADDR_SOUNDCNT_L)
#define REG_NR50        (*(vu8  *)REG_ADDR_NR50)
#define REG_NR51        (*(vu8  *)REG_ADDR_NR51)
#define REG_SOUNDCNT_H  (*(vu32 *)REG_ADDR_SOUNDCNT_H)
#define REG_SOUNDCNT_X  (*(vu32 *)REG_ADDR_SOUNDCNT_X)
#define REG_NR52        (*(vu8  *)REG_ADDR_NR52)
#define REG_SOUNDBIAS   (*(vu32 *)REG_ADDR_SOUNDBIAS)
...
#define REG_DMA0CNT_L   (*(vu32 *)REG_ADDR_DMA0CNT_L)
#define REG_DMA0CNT_H   (*(vu32 *)REG_ADDR_DMA0CNT_H)

#define REG_DMA1SAD     (*(vu32 *)REG_ADDR_DMA1SAD)
#define REG_DMA1DAD     (*(vu32 *)REG_ADDR_DMA1DAD)
#define REG_DMA1CNT     (*(vu32 *)REG_ADDR_DMA1CNT)
#define REG_DMA1CNT_L   (*(vu32 *)REG_ADDR_DMA1CNT_L)
#define REG_DMA1CNT_H   (*(vu32 *)REG_ADDR_DMA1CNT_H)

#define REG_DMA2SAD     (*(vu32 *)REG_ADDR_DMA2SAD)
#define REG_DMA2DAD     (*(vu32 *)REG_ADDR_DMA2DAD)
#define REG_DMA2CNT     (*(vu32 *)REG_ADDR_DMA2CNT)
#define REG_DMA2CNT_L   (*(vu32 *)REG_ADDR_DMA2CNT_L)
#define REG_DMA2CNT_H   (*(vu32 *)REG_ADDR_DMA2CNT_H)

#define REG_DMA3SAD     (*(vu32 *)REG_ADDR_DMA3SAD)
#define REG_DMA3DAD     (*(vu32 *)REG_ADDR_DMA3DAD)
#define REG_DMA3CNT     (*(vu32 *)REG_ADDR_DMA3CNT)
#define REG_DMA3CNT_L   (*(vu32 *)REG_ADDR_DMA3CNT_L)
#define REG_DMA3CNT_H   (*(vu32 *)REG_ADDR_DMA3CNT_H)

#define REG_TMCNT(n)    (*(vu32 *)(REG_ADDR_TMCNT + ((n) * 4)))
#define REG_TMCNT_L(n)  (*(vu32 *)(REG_ADDR_TMCNT_L + ((n) * 4)))
#define REG_TMCNT_H(n)  (*(vu32 *)(REG_ADDR_TMCNT_H + ((n) * 4)))
#define REG_TM0CNT      (*(vu32 *)REG_ADDR_TM0CNT)
#define REG_TM0CNT_L    (*(vu32 *)REG_ADDR_TM0CNT_L)
#define REG_TM0CNT_H    (*(vu32 *)REG_ADDR_TM0CNT_H)
#define REG_TM1CNT      (*(vu32 *)REG_ADDR_TM1CNT)
#define REG_TM1CNT_L    (*(vu32 *)REG_ADDR_TM1CNT_L)
#define REG_TM1CNT_H    (*(vu32 *)REG_ADDR_TM1CNT_H)
#define REG_TM2CNT      (*(vu32 *)REG_ADDR_TM2CNT)
#define REG_TM2CNT_L    (*(vu32 *)REG_ADDR_TM2CNT_L)
#define REG_TM2CNT_H    (*(vu32 *)REG_ADDR_TM2CNT_H)
#define REG_TM3CNT      (*(vu32 *)REG_ADDR_TM3CNT)
#define REG_TM3CNT_L    (*(vu32 *)REG_ADDR_TM3CNT_L)
#define REG_TM3CNT_H    (*(vu32 *)REG_ADDR_TM3CNT_H)

#define REG_SIOCNT      (*(vu32 *)REG_ADDR_SIOCNT)
#define REG_SIODATA8    (*(vu32 *)REG_ADDR_SIODATA8)
#define REG_SIODATA32   (*(vu32 *)REG_ADDR_SIODATA32)
#define REG_SIOMLT_SEND (*(vu32 *)REG_ADDR_SIOMLT_SEND)
#define REG_SIOMLT_RECV (*(vu64 *)REG_ADDR_SIOMLT_RECV)
#define REG_SIOMULTI(n) (*(vu32 *)(REG_ADDR_SIOMULTI0 + (n) * 2))
#define REG_SIOMULTI0   (*(vu32 *)REG_ADDR_SIOMULTI0)
#define REG_SIOMULTI1   (*(vu32 *)REG_ADDR_SIOMULTI1)
#define REG_SIOMULTI2   (*(vu32 *)REG_ADDR_SIOMULTI2)
#define REG_SIOMULTI3   (*(vu32 *)REG_ADDR_SIOMULTI3)

#define REG_KEYINPUT    (*(vu32 *)REG_ADDR_KEYINPUT)
#define REG_KEYCNT      (*(vu32 *)REG_ADDR_KEYCNT)

#define REG_RCNT        (*(vu32 *)REG_ADDR_RCNT)

#define REG_IME         (*(vu32 *)REG_ADDR_IME)
#define REG_IE          (*(vu32 *)REG_ADDR_IE)
#define REG_IF          (*(vu32 *)REG_ADDR_IF)

#define REG_WAITCNT     (*(vu32 *)REG_ADDR_WAITCNT)
