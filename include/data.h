...
struct Trainer
{
    ...
    /*0x08*/ u32 items[MAX_TRAINER_ITEMS];
...
struct TypeInfo
{
    ...
    u32 zMove;
    u32 maxMove;
    u32 teraTypeRGBValue;    // Most values pulled from the Tera type icon palette.
    u32 damageCategory:2;    // Used for B_PHYSICAL_SPECIAL_SPLIT <= GEN_3
    u32 useSecondTypeIconPalette:1;
    u32 isSpecialCaseType:1;
    u32 isHiddenPowerType:1; // Changing this for any type will change the distribution of all Hidden Power types from vanilla.
    u32 padding:11;
...
extern const u32 gMinigameDigits_Pal[];
...
static inline u32 SanitizeTrainerId(u32 trainerId)
{
...
static inline const struct Trainer *GetTrainerStructFromId(u32 trainerId)
{
...
static inline const u8 GetTrainerClassFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
...
static inline const u8 *GetTrainerClassNameFromId(u32 trainerId)
{
...
static inline const u8 *GetTrainerNameFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
...
static inline const u8 GetTrainerPicFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
...
static inline const u8 GetTrainerStartingStatusFromId(u32 trainerId)
{
    return gTrainers[GetCurrentDifficultyLevel()][SanitizeTrainerId(trainerId)].startingStatus;
}

static inline const bool32 IsTrainerDoubleBattle(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
...
static inline const u8 GetTrainerPartySizeFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
...
static inline const bool32 DoesTrainerHaveMugshot(u32 trainerId)
{
    return gTrainers[GetCurrentDifficultyLevel()][SanitizeTrainerId(trainerId)].mugshotColor;
}

static inline const u8 GetTrainerMugshotColorFromId(u32 trainerId)
{
    return gTrainers[GetCurrentDifficultyLevel()][SanitizeTrainerId(trainerId)].mugshotColor;
}

static inline const u32 *GetTrainerItemsFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
...
static inline const struct TrainerMon *GetTrainerPartyFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
...
static inline const bool32 GetTrainerAIFlagsFromId(u32 trainerId)
{
    u32 sanitizedTrainerId = SanitizeTrainerId(trainerId);
    enum DifficultyLevel difficulty = GetTrainerDifficultyLevel(sanitizedTrainerId);
