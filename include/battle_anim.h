...
extern bool32 gAnimScriptActive;
extern u8 gAnimVisualTaskCount;
extern u8 gAnimSoundTaskCount;
extern struct DisableStruct *gAnimDisableStructPtr;
extern s32 gAnimMoveDmg;
extern u32 gAnimMovePower;
extern u8 gAnimFriendship;
extern u32 gWeatherMoveAnim;
extern s32 gBattleAnimArgs[ANIM_ARGS_COUNT];
extern u8 gAnimMoveTurn;
extern u8 gBattleAnimAttacker;
extern u8 gBattleAnimTarget;
extern u32 gAnimBattlerSpecies[MAX_BATTLERS_COUNT];
extern u8 gAnimCustomPanning;
extern u32 gAnimMoveIndex;

void ClearBattleAnimationVars(void);
void DoMoveAnim(u32 move);
...
void ResetBattleAnimBg(bool32);
void LoadMoveBg(u32 bgId);

// battle_intro.c
void SetAnimBgAttribute(u8 bgId, u8 attributeId, u8 value);
void DrawBattlerOnBg(int bgId, u8 x, u8 y, u8 battlerPosition, u8 paletteId, u8 *tiles, u32 *tilemap, u32 tilesOffset);
...
void *LoadPointerFromVars(s32 bottom, s32 top);
void StorePointerInVars(s32 *bottom, s32 *top, const void *ptr);
...
void UpdateAnimBg3ScreenSize(bool32);
...
void SetGrayscaleOrOriginalPalette(u32 palNum, bool32 restoreOriginal);
...
void StartMonScrollingBgMask(u8 taskId, int unused, u32 scrollSpeed, u8 battler, bool32 includePartner, u8 numFadeSteps, u8 fadeStepDelay, u8 duration, const u32 *gfx, const u32 *tilemap, const u32 *palette);
...
u32 UnpackSelectedBattlePalettes(s32);

u8 GetBattlerSpriteFinal_Y(u8, u32, u8);
