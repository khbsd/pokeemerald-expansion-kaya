...
void DrawStdFrameWithCustomTileAndPalette(u8 windowId, bool32 copyToVram, u32 tileStart, u8 palette);
...
void AddTextPrinterParameterized4(u8 windowId, u8 fontId, u8 x, u8 y, u8 letterSpacing, u8 lineSpacing, const u8 *color, s32 speed, const u8 *str);
