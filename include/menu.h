...
extern const u32 gStandardMenuPalette[];
...
void PrintPlayerNameOnWindow(u8, const u8 *, u32, u32);
...
void AddTextPrinterWithCallbackForMessage(bool8 canSpeedUp, void (*callback)(struct TextPrinterTemplate *, u32));
void BgDmaFill(u32 bg, u8 value, int offset, int size);
void AddTextPrinterParameterized3(u8 windowId, u8 fontId, u8 left, u8 top, const u8 *color, s8 speed, const u8 *str);
void ClearStdWindowAndFrameToTransparent(u8 windowId, bool8 copyToVram);
void SetWindowTemplateFields(struct WindowTemplate *template, u8 priority, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 palNum, u32 baseBlock);
void DrawStdFrameWithCustomTileAndPalette(u8 windowId, bool8 copyToVram, u32 tileStart, u8 palette);
...
void CreateYesNoMenu(const struct WindowTemplate *windowTemplate, u32 borderFirstTileNum, u8 borderPalette, u8 initialCursorPos);
...
void DrawDialogFrameWithCustomTileAndPalette(u8 windowId, bool8 copyToVram, u32 tileNum, u8 paletteNum);
