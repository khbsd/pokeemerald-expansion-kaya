...
int GetUnionRoomTradeMessageId(struct RfuGameCompatibilityData player, struct RfuGameCompatibilityData partner, u32 playerSpecies2, u32 partnerSpecies, u8 requestedType, u32 playerSpecies, bool32 isModernFatefulEncounter);
