...
u8 AddNewGameBirchObject(s32, s32, u8);
...
bool32 FieldEffectCmd_loadfadedpal(u8 **script, u32 *val);
bool32 FieldEffectCmd_loadpal(u8 **script, u32 *val);
bool32 FieldEffectCmd_callnative(u8 **script, u32 *val);
bool32 FieldEffectCmd_end(u8 **script, u32 *val);
