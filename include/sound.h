...
void PlayCry_NormalNoDucking(u32 species, s8 pan, s8 volume, u8 priority);
void PlayCry_ByMode(u32 species, s8 pan, u8 mode);
void PlayCry_ReleaseDouble(u32 species, s8 pan, u8 mode);
void PlayCry_Script(u32 species, u8 mode);
void PlayCry_DuckNoRestore(u32 species, s8 pan, u8 mode);
void PlayCryInternal(u32 species, s8 pan, s8 volume, u8 priority, u8 mode);
