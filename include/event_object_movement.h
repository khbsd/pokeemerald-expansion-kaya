...
u32 GetObjectEventIdByXY(s32 x, s32 y);
...
void TryMoveObjectEventToMapCoords(u32 localId, u32 mapNum, u32 mapGroup, s32 x, s32 y);
...
u32 CreateObjectGraphicsSprite(u32, void (*)(struct Sprite *), s32 x, s32 y, u32 subpriority);
u32 TrySpawnObjectEvent(u32 localId, u32 mapNum, u32 mapGroup);
u32 SpawnSpecialObjectEventParameterized(u32 graphicsId, u32 movementBehavior, u32 localId, s32 x, s32 y, u32 elevation);
...
void SetObjectInvisibility(u32 localId, u32 mapNum, u32 mapGroup, bool32 invisible);
void FreeAndReserveObjectSpritePalettes(void);
u32 LoadObjectEventPalette(u32 paletteTag);
u32 LoadPlayerObjectEventPalette(u32 gender);
void SetObjectEventSpritePosByLocalIdAndMap(u32 localId, u32 mapNum, u32 mapGroup, s32 x, s32 y);
...
void ShiftObjectEventCoords(struct ObjectEvent *, s32 x, s32 y);
void MoveObjectEventToMapCoords(struct ObjectEvent *, s32 x, s32 y);
...
u32 GetCollisionAtCoords(struct ObjectEvent *, s32 x, s32 y, u32 dir);
u32 GetObjectObjectCollidesWith(struct ObjectEvent *objectEvent, s32 x, s32 y, bool32 addCoords);
void MoveCoords(u32 direction, s32 *x, s32 *y);
...
u32 GetCollisionFlagsAtCoords(struct ObjectEvent *objectEvent, s32 x, s32 y, u32 direction);
...
bool32 ObjectEventSetHeldMovement(struct ObjectEvent *objectEvent, u32 specialAnimId);
...
void ObjectEventMoveDestCoords(struct ObjectEvent *objEvent, u32 direction, s32 *x, s32 *y);
u32 AddCameraObject(u32 linkedSpriteId);
void UpdateObjectEventsForCameraUpdate(s32 x, s32 y);
...
bool32 SpriteAnimEnded(struct Sprite *);
...
u32 GetLedgeJumpDirection(s32 x, s32 y, u32 direction);
...
bool32 IsBerryTreeSparkling(u32 localId, u32 mapNum, u32 mapGroup);
...
u32 CopySprite(struct Sprite *sprite, s32 x, s32 y, u32 subpriority);
u32 CreateCopySpriteAt(struct Sprite *sprite, s32 x, s32 y, u32 subpriority);
bool32 IsElevationMismatchAt(u32, s32, s32);
...
u32 GetVectorDirection(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_SouthNorth(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_WestEast(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_WestNorth(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_EastNorth(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_WestSouth(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_EastSouth(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_SouthNorthWest(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_SouthNorthEast(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_NorthWestEast(s32 dx, s32 dy, s32 absdx, s32 absdy);
u32 GetLimitedVectorDirection_SouthWestEast(s32 dx, s32 dy, s32 absdx, s32 absdy);
...
bool32 CopyablePlayerMovement_None(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_FaceDirection(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_WalkNormal(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_WalkFast(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_WalkFaster(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_Slide(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_JumpInPlace(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_Jump(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
...
bool32 FollowablePlayerMovement_Idle(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_FaceDirection(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_Step(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_GoSpeed1(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_GoSpeed2(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_Slide(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_JumpInPlace(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_GoSpeed4(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 FollowablePlayerMovement_Jump(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
bool32 CopyablePlayerMovement_Jump2(struct ObjectEvent *, struct Sprite *, u32, bool32(u32));
...
u32 CreateVirtualObject(u32 graphicsId, u32 virtualObjId, s32 x, s32 y, u32 elevation, u32 direction);
...
//sideways stairs
u32 GetSidewaysStairsToRightDirection(s32, s32, u32);
u32 GetSidewaysStairsToLeftDirection(s32, s32, u32);
u32 GetSidewaysStairsCollision(struct ObjectEvent *objectEvent, u32 dir, u32 currentBehavior, u32 nextBehavior, u32 collision);

bool32 MovementAction_EmoteX_Step0(struct ObjectEvent *, struct Sprite *);
bool32 MovementAction_EmoteDoubleExclamationMark_Step0(struct ObjectEvent *, struct Sprite *);
