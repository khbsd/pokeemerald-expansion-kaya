...
#define P_FLAG_LEVEL_UP_MOVES              FLAG_UNUSED_0x264       // If this flag is set, enables level up move relearner.
#define P_FLAG_EGG_MOVES                   FLAG_UNUSED_0x265       // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES                 FLAG_UNUSED_0x266       // If this flag is set, enables tutor move move relearner.
#define P_FLAG_TMHM_MOVES                  FLAG_UNUSED_0x267       // If this flag is set, enables tutor move move relearner.
