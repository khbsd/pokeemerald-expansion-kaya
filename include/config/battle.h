...
#define B_EVOLUTION_DURING_BATTLE   TRUE
...
// Other battle flags
#define B_BADGE_BOOST_AMOUNT        1.2   // Vanilla is 1.1
...
#define B_BADGE_CATCH_BOOST             TRUE       // If TRUE, number of badges owned is multiplied by 10 and added to your capture odds
#define B_MISSING_BADGE_CATCH_MALUS     GEN_3_REDUX // In Gen9, a penalty is added to the catch rate if trying to catch a mon 5 levels above the current obedience level, based on the number of gym badges obtained.
...
#define B_CRITICAL_CAPTURE_GYM_BOOST    TRUE       // If set to TRUE, Critical Capture scales with # of gym badges
...
#define B_MEGAS_GET_AFFECTION           TRUE       // If this is set to TRUE, Mega Evolved Pokémon will benefit from affection levels
...
#define B_OBEDIENCE_MECHANICS           GEN_3_REDUX // In PLA+ (here Gen8+), obedience restrictions also apply to non-outsider Pokémon, albeit based on their level met rather than actual level
...
#define B_DYNAMAX_BAND                  FALSE
#define B_Z_POWER_RING                  FALSE
...
// Animation Settings
#define B_NEW_PARTICLES_ALL             TRUE
#define B_NEW_SWORD_PARTICLE            B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Swords Dance's particle.
#define B_NEW_LEECH_SEED_PARTICLE       B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Leech Seed's animation particle.
#define B_NEW_HORN_ATTACK_PARTICLE      B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Horn Attack's horn particle.
#define B_NEW_ROCKS_PARTICLE            B_NEW_PARTICLES_ALL    // If set to TRUE, it updates rock particles.
#define B_NEW_LEAF_PARTICLE             B_NEW_PARTICLES_ALL    // If set to TRUE, it updates leaf particle.
#define B_NEW_EMBER_PARTICLES           B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Ember's fire particle.
#define B_NEW_MEAN_LOOK_PARTICLE        B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Mean Look's eye particle.
#define B_NEW_TEETH_PARTICLE            B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Bite/Crunch teeth particle.
#define B_NEW_HANDS_FEET_PARTICLE       B_NEW_PARTICLES_ALL    // If set to TRUE, it updates chop/kick/punch particles.
#define B_NEW_SPIKES_PARTICLE           B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Spikes particle.
#define B_NEW_FLY_BUBBLE_PARTICLE       B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Fly's 'bubble' particle.
#define B_NEW_CURSE_NAIL_PARTICLE       B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Curse's nail.
#define B_NEW_BATON_PASS_BALL_PARTICLE  B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Baton Pass' Poké Ball sprite.
#define B_NEW_MORNING_SUN_STAR_PARTICLE B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Morning Sun's star particles.
#define B_NEW_IMPACT_PALETTE            B_NEW_PARTICLES_ALL    // If set to TRUE, it updates the basic 'hit' palette.
#define B_NEW_SURF_PARTICLE_PALETTE     B_NEW_PARTICLES_ALL    // If set to TRUE, it updates Surf's wave palette.
#define B_PSYDUCK_CONFUSION_DUCKS       TRUE                   // If set to TRUE, the confusion ducks will be little Psyducks instead of regular ducks.
...
#define B_MOVE_TYPE_SPRITES                 TRUE  // If TRUE, will display a type icon like in the summary screen instead of the type text in the move PP/Type window.
