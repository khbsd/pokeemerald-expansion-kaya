...
#define OW_ITEM_DESCRIPTIONS_IN_BAG     3   // show description if item is not in bag
...
#define OW_BERRY_MUTATION_CHANCE       10         // Determines the % chance of a mutation.
...
// Time
#define OW_TIMES_OF_DAY                 GEN_3_REDUX  // Different generations have the times of day change at different times.
...
// Gym rematch flag
#define OW_FLAG_GYM_RANDOM_REMATCH 0   // can also use FLAG_RANDOM_GYM_REMATCH
