...
#define I_ENABLE_POKEVIAL               FALSE        // A reusable item that can heal your entire party. Options are in constants/pokevial.h
...
#define I_EXP_SHARE_FLAG        0x21           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    1       // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
