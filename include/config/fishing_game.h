...
#define DEFAULT_TREASURE_SCORE_PAUSE        FALSE   // If TRUE, the minigame score will not decrease while the treasure is within the fishing bar. Overridden if a flag is assigned to FG_FLAG_TREASURE_SCORE_PAUSE.
#define TREASURE_SLOW_SCORE_DRAIN           TRUE
