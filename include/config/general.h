...
#define TEXT_SPEED_MEDIUM_MODIFIER   8       // How fast the MID text speed option prints
#define TEXT_SPEED_FAST_MODIFIER     16       // How fast the FAST text speed option prints
