...
u8 LoadBgVram(u32 bg, const void *src, u32 size, u32 destOffset, u32 mode);
...
void CopyRectToBgTilemapBufferRect(u32 bg, const void *src, u8 srcX, u8 srcY, u8 srcWidth, u8 srcHeight, u8 destX, u8 destY, u8 rectWidth, u8 rectHeight, u8 palette1, s32 tileOffset, s32 palette2);
void FillBgTilemapBufferRect_Palette0(u32 bg, u32 tileNum, u8 x, u8 y, u8 width, u8 height);
void FillBgTilemapBufferRect(u32 bg, u32 tileNum, u8 x, u8 y, u8 width, u8 height, u8 palette);
void WriteSequenceToBgTilemapBuffer(u32 bg, u32 firstTileNum, u8 x, u8 y, u8 width, u8 height, u8 paletteSlot, s32 tileNumDelta);
