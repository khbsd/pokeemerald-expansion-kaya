...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_DODGED_ATTACK]                         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} dodged the attack!"),
    ...
    [STRINGID_PKMNATKSEEDED]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was seeded!"),
    ...
    [STRINGID_PKMNTOOKFOE]                          = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} took its attacker down with it!"),
    ...
    [STRINGID_QUEENLYMAJESTYENTERS]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is exerting her majesty!"),
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_QUEENLY_MAJESTY] = STRINGID_QUEENLYMAJESTYENTERS,
...
{
    [B_MSG_MISSED]      = STRINGID_DODGED_ATTACK,
...
{
    [B_MSG_KO_MISS]       = STRINGID_DODGED_ATTACK,
...
const u8 gText_BattleWallyName[] = _("SALLY");
