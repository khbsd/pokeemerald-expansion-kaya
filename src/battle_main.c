...
u8 CreateRematchPool(struct Pokemon *party, const struct Trainer *trainer, u32 trainerNum, bool32 firstTrainer, u32 battleTypeFlags);
...
EWRAM_DATA enum Abilities gLastUsedAbility = 0;
...
// TODO: combine 2nd, 3rd, and 4th pools w/ 5th one
u8 CreateRematchPool(struct Pokemon *party, const struct Trainer *trainer, u32 trainerNum, bool32 firstTrainer, u32 battleTypeFlags)
{
...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum, bool8 firstTrainer)
{
    ...
    {
        if (IsFifthGymRematch(trainerNum))
            retVal = CreateRematchPool(party, GetTrainerStructFromId(trainerNum), trainerNum, firstTrainer, gBattleTypeFlags);
        else
...
{
    return (trainerNum == TRAINER_ROXANNE_5 || trainerNum == TRAINER_BRAWLY_5 || trainerNum == TRAINER_WATTSON_5 || trainerNum == TRAINER_FLANNERY_5 || trainerNum == TRAINER_NORMAN_5 || trainerNum == TRAINER_WINONA_5 || trainerNum == TRAINER_TATE_AND_LIZA_5 || trainerNum == TRAINER_JUAN_5);
}
...
u32 GetBattlerTotalSpeedStatArgs(u32 battler, enum Abilities ability, enum ItemHoldEffect holdEffect)
{
...
s32 GetChosenMovePriority(u32 battler, enum Abilities ability)
{
    u16 move;
...
s32 GetBattleMovePriority(u32 battler, enum Abilities ability, u32 move)
{
    s32 priority = 0;
...
s32 GetWhichBattlerFasterArgs(u32 battler1, u32 battler2, bool32 ignoreChosenMoves, enum Abilities ability1, enum Abilities ability2,
...
s32 GetWhichBattlerFasterOrTies(u32 battler1, u32 battler2, bool32 ignoreChosenMoves)
{
    ...
    enum Abilities ability1 = GetBattlerAbility(battler1);
    ...
    enum Abilities ability2 = GetBattlerAbility(battler2);
...
u32 TrySetAteType(u32 move, u32 battlerAtk, enum Abilities attackerAbility)
{
