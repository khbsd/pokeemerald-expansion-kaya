...
struct GFRomHeader
{
    ...
    const u32 *const * monIcons;
    const u32 *monIconPaletteIds;
    const struct SpritePalette * monIconPalettes;
    const u32 (* monSpeciesNames)[];
    const u32 (* moveNames)[];
    ...
    u32 trainerNameLength;
    u32 pokemonNameLength1;
    u32 pokemonNameLength2;
    u32 unk5;
    u32 unk6;
    u32 unk7;
    u32 unk8;
    ...
    const u32 (* abilityNames)[];
    const u32 *const * abilityDescriptions;
    ...
    u32 ribbonFlag;
    u32 bagCountItems;
    u32 bagCountKeyItems;
    u32 bagCountPokeballs;
    u32 bagCountTMHMs;
    u32 bagCountBerries;
    u32 pcItemsCount;
    u32 pcItemsOffset;
