...
static void PrintEvolutionTargetSpeciesAndMethod(u8 taskId, enum Species species, u8 depth, u32 *depth_i, u32 alreadyPrintedIcons[], u32 *icon_depth_i);
...
static void CreateCaughtBallEvolutionScreen(enum Species targetSpecies, u8 x, u8 y)
{
