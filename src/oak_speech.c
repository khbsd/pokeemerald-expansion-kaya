...
static void Task_OakSpeech_ShowGenderOptions(u8 taskId)
{
    if (!IsTextPrinterActiveOnWindow(WIN_INTRO_TEXTBOX))
    {
        ...
        AddTextPrinterParameterized3(gTasks[taskId].tMenuWindowId, FONT_NORMAL, 8, 1, sOakSpeechResources->textColor, 0, gText_Butchy);
        sOakSpeechResources->textColor[0] = 1;
        sOakSpeechResources->textColor[1] = 2;
        sOakSpeechResources->textColor[2] = 3;
        AddTextPrinterParameterized3(gTasks[taskId].tMenuWindowId, FONT_NORMAL, 8, 17, sOakSpeechResources->textColor, 0, gText_Femme);
...
static void Task_OakSpeech_HandleGenderInput(u8 taskId)
{
    ...
    case 0: // BOY
        ...
        break;
    case 1: // GIRL
        gSaveBlock2Ptr->playerGender = FEMME;
        break;
    case MENU_B_PRESSED:
...
static void PrintNameChoiceOptions(u8 taskId, u8 hasPlayerBeenNamed)
{
    ...
    if (hasPlayerBeenNamed == FALSE)
        textPtrs = gSaveBlock2Ptr->playerGender == BUTCHY ? sMaleNameChoices : sFemaleNameChoices;
    else
