...
static const u32 sTextColors[] = { TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY };
...
static void AddTextPrinterForUnionRoomBattle(u32 windowId, const u32 *str, u32 x, u32 y, s32 speed)
{
    s32 letterSpacing = 0;
    s32 lineSpacing = 1;
