...
void CreateScriptedWildMon(u16 species, u8 level, u16 item)
{
    ...
    if (OW_SYNCHRONIZE_NATURE > GEN_3)
        ...
        CreateMon(&gEnemyParty[0], species, level, USE_RANDOM_IVS, 0, 0, OT_ID_PLAYER_ID, 0, FALSE, FALSE);
    if (item)
    {
        heldItem[0] = item;
        heldItem[1] = item >> 8;
...
void CreateScriptedDoubleWildMon(u16 species1, u8 level1, u16 item1, u16 species2, u8 level2, u16 item2)
{
    ...
    if (OW_SYNCHRONIZE_NATURE > GEN_3)
        ...
        CreateMon(&gEnemyParty[0], species1, level1, 32, 0, 0, OT_ID_PLAYER_ID, 0, FALSE, FALSE);
    if (item1)
    {
        heldItem1[0] = item1;
        heldItem1[1] = item1 >> 8;
    ...
    if (OW_SYNCHRONIZE_NATURE > GEN_3)
        ...
        CreateMon(&gEnemyParty[1], species2, level2, 32, 0, 0, OT_ID_PLAYER_ID, 0, FALSE, FALSE);
    if (item2)
    {
        heldItem2[0] = item2;
        heldItem2[1] = item2 >> 8;
