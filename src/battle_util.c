...
bool32 IsAbilityAndRecord(u32 battler, enum Ability battlerAbility, u32 abilityToCheck)
{
...
enum Ability GetBattlerAbilityInternal(u32 battler, u32 ignoreMoldBreaker, u32 noAbilityShield)
{
