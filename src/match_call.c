...
{
    int callChance = 1;
    if (!GetMonData(&gPlayerParty[0], MON_DATA_SANITY_IS_EGG) && (GetMonAbility(&gPlayerParty[0]) == ABILITY_LIGHTNING_ROD || GetMonAbility(&gPlayerParty[0]) == ABILITY_GEOELECTRIC))
        callChance = 2;
