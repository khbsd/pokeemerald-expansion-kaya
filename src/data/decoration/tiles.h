...
const u32 DecorGfx_SMALL_DESK[] = {
    DECOR_TILE(SmallDesk)
};

const u32 DecorGfx_POKEMON_DESK[] = {
    DECOR_TILE(PokemonDesk)
};

const u32 DecorGfx_HEAVY_DESK[] = {
...
const u32 DecorGfx_RAGGED_DESK[] = {
...
const u32 DecorGfx_COMFORT_DESK[] = {
...
const u32 DecorGfx_PRETTY_DESK[] = {
...
const u32 DecorGfx_SMALL_CHAIR[] = {
    DECOR_TILE(SmallChair)
};

const u32 DecorGfx_POKEMON_CHAIR[] = {
    DECOR_TILE(PokemonChair)
};

const u32 DecorGfx_HEAVY_CHAIR[] = {
    DECOR_TILE(HeavyChair)
};

const u32 DecorGfx_PRETTY_CHAIR[] = {
    DECOR_TILE(PrettyChair)
};

const u32 DecorGfx_COMFORT_CHAIR[] = {
    DECOR_TILE(ComfortChair)
};

const u32 DecorGfx_RAGGED_CHAIR[] = {
    DECOR_TILE(RaggedChair)
};

const u32 DecorGfx_BRICK_CHAIR[] = {
    DECOR_TILE(BrickChair)
};

const u32 DecorGfx_CAMP_CHAIR[] = {
    DECOR_TILE(CampChair)
};

const u32 DecorGfx_HARD_CHAIR[] = {
    DECOR_TILE(HardChair)
};

const u32 DecorGfx_RED_PLANT[] = {
    DECOR_TILE(RedPlant_Top),
    DECOR_TILE(RedPlant_Base1)
};

const u32 DecorGfx_TROPICAL_PLANT[] = {
    DECOR_TILE(TropicalPlant_Top),
    DECOR_TILE(TropicalPlant_Base1)
};

const u32 DecorGfx_PRETTY_FLOWERS[] = {
    DECOR_TILE(PrettyFlowers_Top),
    DECOR_TILE(PrettyFlowers_Base1)
};

const u32 DecorGfx_COLORFUL_PLANT[] = {
...
const u32 DecorGfx_GORGEOUS_PLANT[] = {
...
const u32 DecorGfx_SOLID_BOARD[] = {
    DECOR_TILE(SolidBoard_Top),
    DECOR_TILE(SolidBoard_Bottom)
};

const u32 DecorGfx_SLIDE[] = {
...
const u32 DecorGfx_FENCE_LENGTH[] = {
    DECOR_TILE(Fence_Vertical)
};

const u32 DecorGfx_FENCE_WIDTH[] = {
    DECOR_TILE(Fence_Horizontal)
};

const u32 DecorGfx_TIRE[] = {
...
const u32 DecorGfx_MUD_BALL[] = {
    DECOR_TILE(MudBall)
};

const u32 DecorGfx_BREAKABLE_DOOR[] = {
    DECOR_TILE(BreakableDoor_TopClosed),
    DECOR_TILE(BreakableDoor_BottomClosed)
};

const u32 DecorGfx_SAND_ORNAMENT[] = {
    DECOR_TILE(SandOrnament_Top),
    DECOR_TILE(SandOrnament_Base1)
};

const u32 DecorGfx_SILVER_SHIELD[] = {
    DECOR_TILE(SilverShield_Top),
    DECOR_TILE(SilverShield_Base1)
};

const u32 DecorGfx_GOLD_SHIELD[] = {
    DECOR_TILE(GoldShield_Top),
    DECOR_TILE(GoldShield_Base1)
};

const u32 DecorGfx_GLASS_ORNAMENT[] = {
    DECOR_TILE(GlassOrnament_Top),
    DECOR_TILE(GlassOrnament_Base1)
};

const u32 DecorGfx_TV[] = {
    DECOR_TILE(TV)
};

const u32 DecorGfx_ROUND_TV[] = {
    DECOR_TILE(RoundTV)
};

const u32 DecorGfx_CUTE_TV[] = {
    DECOR_TILE(CuteTV)
};

const u32 DecorGfx_GLITTER_MAT[] = {
    DECOR_TILE(GlitterMat)
};

const u32 DecorGfx_JUMP_MAT[] = {
    DECOR_TILE(JumpMat)
};

const u32 DecorGfx_SPIN_MAT[] = {
    DECOR_TILE(SpinMat)
};

const u32 DecorGfx_C_LOW_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_C_Low)
};

const u32 DecorGfx_D_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_D)
};

const u32 DecorGfx_E_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_E)
};

const u32 DecorGfx_F_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_F)
};

const u32 DecorGfx_G_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_G)
};

const u32 DecorGfx_A_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_A)
};

const u32 DecorGfx_B_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_B)
};

const u32 DecorGfx_C_HIGH_NOTE_MAT[] = {
    DECOR_TILE(NoteMat_C_High)
};

const u32 DecorGfx_SURF_MAT[] = {
...
const u32 DecorGfx_THUNDER_MAT[] = {
...
const u32 DecorGfx_FIRE_BLAST_MAT[] = {
...
const u32 DecorGfx_POWDER_SNOW_MAT[] = {
...
const u32 DecorGfx_ATTRACT_MAT[] = {
...
const u32 DecorGfx_FISSURE_MAT[] = {
...
const u32 DecorGfx_BALL_POSTER[] = {
    DECOR_TILE(BallPoster)
};

const u32 DecorGfx_GREEN_POSTER[] = {
    DECOR_TILE(GreenPoster)
};

const u32 DecorGfx_RED_POSTER[] = {
    DECOR_TILE(RedPoster)
};

const u32 DecorGfx_BLUE_POSTER[] = {
    DECOR_TILE(BluePoster)
};

const u32 DecorGfx_CUTE_POSTER[] = {
    DECOR_TILE(CutePoster)
};

const u32 DecorGfx_PIKA_POSTER[] = {
    DECOR_TILE(PikaPoster_Left),
    DECOR_TILE(PikaPoster_Right)
};

const u32 DecorGfx_LONG_POSTER[] = {
    DECOR_TILE(LongPoster_Left),
    DECOR_TILE(LongPoster_Right)
};

const u32 DecorGfx_SEA_POSTER[] = {
    DECOR_TILE(SeaPoster_Left),
    DECOR_TILE(SeaPoster_Right)
};

const u32 DecorGfx_SKY_POSTER[] = {
    DECOR_TILE(SkyPoster_Left),
    DECOR_TILE(SkyPoster_Right)
};

const u32 DecorGfx_KISS_POSTER[] = {
    DECOR_TILE(KissPoster_Left),
    DECOR_TILE(KissPoster_Right)
};

const u32 DecorGfx_PICHU_DOLL[] = {
    OBJ_EVENT_GFX_PICHU_DOLL
};

const u32 DecorGfx_PIKACHU_DOLL[] = {
    OBJ_EVENT_GFX_PIKACHU_DOLL
};

const u32 DecorGfx_MARILL_DOLL[] = {
    OBJ_EVENT_GFX_MARILL_DOLL
};

const u32 DecorGfx_TOGEPI_DOLL[] = {
    OBJ_EVENT_GFX_TOGEPI_DOLL
};

const u32 DecorGfx_CYNDAQUIL_DOLL[] = {
    OBJ_EVENT_GFX_CYNDAQUIL_DOLL
};

const u32 DecorGfx_CHIKORITA_DOLL[] = {
    OBJ_EVENT_GFX_CHIKORITA_DOLL
};

const u32 DecorGfx_TOTODILE_DOLL[] = {
    OBJ_EVENT_GFX_TOTODILE_DOLL
};

const u32 DecorGfx_JIGGLYPUFF_DOLL[] = {
    OBJ_EVENT_GFX_JIGGLYPUFF_DOLL
};

const u32 DecorGfx_MEOWTH_DOLL[] = {
    OBJ_EVENT_GFX_MEOWTH_DOLL
};

const u32 DecorGfx_CLEFAIRY_DOLL[] = {
    OBJ_EVENT_GFX_CLEFAIRY_DOLL
};

const u32 DecorGfx_DITTO_DOLL[] = {
    OBJ_EVENT_GFX_DITTO_DOLL
};

const u32 DecorGfx_SMOOCHUM_DOLL[] = {
    OBJ_EVENT_GFX_SMOOCHUM_DOLL
};

const u32 DecorGfx_TREECKO_DOLL[] = {
    OBJ_EVENT_GFX_TREECKO_DOLL
};

const u32 DecorGfx_TORCHIC_DOLL[] = {
    OBJ_EVENT_GFX_TORCHIC_DOLL
};

const u32 DecorGfx_MUDKIP_DOLL[] = {
    OBJ_EVENT_GFX_MUDKIP_DOLL
};

const u32 DecorGfx_DUSKULL_DOLL[] = {
    OBJ_EVENT_GFX_DUSKULL_DOLL
};

const u32 DecorGfx_WYNAUT_DOLL[] = {
    OBJ_EVENT_GFX_WYNAUT_DOLL
};

const u32 DecorGfx_BALTOY_DOLL[] = {
    OBJ_EVENT_GFX_BALTOY_DOLL
};

const u32 DecorGfx_KECLEON_DOLL[] = {
    OBJ_EVENT_GFX_KECLEON_DOLL
};

const u32 DecorGfx_AZURILL_DOLL[] = {
    OBJ_EVENT_GFX_AZURILL_DOLL
};

const u32 DecorGfx_SKITTY_DOLL[] = {
    OBJ_EVENT_GFX_SKITTY_DOLL
};

const u32 DecorGfx_SWABLU_DOLL[] = {
    OBJ_EVENT_GFX_SWABLU_DOLL
};

const u32 DecorGfx_GULPIN_DOLL[] = {
    OBJ_EVENT_GFX_GULPIN_DOLL
};

const u32 DecorGfx_LOTAD_DOLL[] = {
    OBJ_EVENT_GFX_LOTAD_DOLL
};

const u32 DecorGfx_SEEDOT_DOLL[] = {
    OBJ_EVENT_GFX_SEEDOT_DOLL
};

const u32 DecorGfx_PIKA_CUSHION[] = {
    OBJ_EVENT_GFX_PIKA_CUSHION
};

const u32 DecorGfx_ROUND_CUSHION[] = {
    OBJ_EVENT_GFX_ROUND_CUSHION
};

const u32 DecorGfx_KISS_CUSHION[] = {
    OBJ_EVENT_GFX_KISS_CUSHION
};

const u32 DecorGfx_ZIGZAG_CUSHION[] = {
    OBJ_EVENT_GFX_ZIGZAG_CUSHION
};

const u32 DecorGfx_SPIN_CUSHION[] = {
    OBJ_EVENT_GFX_SPIN_CUSHION
};

const u32 DecorGfx_DIAMOND_CUSHION[] = {
    OBJ_EVENT_GFX_DIAMOND_CUSHION
};

const u32 DecorGfx_BALL_CUSHION[] = {
    OBJ_EVENT_GFX_BALL_CUSHION
};

const u32 DecorGfx_GRASS_CUSHION[] = {
    OBJ_EVENT_GFX_GRASS_CUSHION
};

const u32 DecorGfx_FIRE_CUSHION[] = {
    OBJ_EVENT_GFX_FIRE_CUSHION
};

const u32 DecorGfx_WATER_CUSHION[] = {
    OBJ_EVENT_GFX_WATER_CUSHION
};

const u32 DecorGfx_SNORLAX_DOLL[] = {
    OBJ_EVENT_GFX_BIG_SNORLAX_DOLL
};

const u32 DecorGfx_RHYDON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_RHYDON_DOLL
};

const u32 DecorGfx_LAPRAS_DOLL[] = {
    OBJ_EVENT_GFX_BIG_LAPRAS_DOLL
};

const u32 DecorGfx_VENUSAUR_DOLL[] = {
    OBJ_EVENT_GFX_BIG_VENUSAUR_DOLL
};

const u32 DecorGfx_CHARIZARD_DOLL[] = {
    OBJ_EVENT_GFX_BIG_CHARIZARD_DOLL
};

const u32 DecorGfx_BLASTOISE_DOLL[] = {
    OBJ_EVENT_GFX_BIG_BLASTOISE_DOLL
};

const u32 DecorGfx_WAILMER_DOLL[] = {
    OBJ_EVENT_GFX_BIG_WAILMER_DOLL
};

const u32 DecorGfx_REGIROCK_DOLL[] = {
    OBJ_EVENT_GFX_BIG_REGIROCK_DOLL
};

const u32 DecorGfx_REGICE_DOLL[] = {
    OBJ_EVENT_GFX_BIG_REGICE_DOLL
};

const u32 DecorGfx_REGISTEEL_DOLL[] = {
