const u32 gBerryFixGbaConnect_Pal[] = INCBIN_u32("graphics/berry_fix/gba_connect.gbapal");
...
const u32 gBerryFixGameboyLogo_Pal[] = INCBIN_u32("graphics/berry_fix/logo.gbapal");
...
const u32 gBerryFixGbaTransfer_Pal[] = INCBIN_u32("graphics/berry_fix/gba_transfer.gbapal");
...
const u32 gBerryFixGbaTransferHighlight_Pal[] = INCBIN_u32("graphics/berry_fix/gba_transfer_highlight.gbapal");
...
const u32 gBerryFixGbaTransferError_Pal[] = INCBIN_u32("graphics/berry_fix/gba_transfer_error.gbapal");
...
const u32 gBerryFixWindow_Pal[] = INCBIN_u32("graphics/berry_fix/window.gbapal");
