...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_NOCTOWL,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_SERENE_GRACE, ABILITY_BLESSED_LUCK },
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_THICK_FAT, ABILITY_HUGE_POWER, ABILITY_SAP_METABOLISM },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_MARILL, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
    ...
    [SPECIES_MARILL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_AZUMARILL}),
    },
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_BALLISTOSPORE, ABILITY_LEAF_GUARD, ABILITY_INFILTRATOR },
    #else
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_JUMPLUFF}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strengthening Heracrush. It is never\n"
            "bothered by soreness in its muscles."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .formSpeciesIdTable = sSneaselFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SNEASLER,
                        CONDITIONS({IF_NOT_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, ITEM_RAZOR_CLAW})}),
    },
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "melt the very ground it stands on, but\n"
            "never painful to Houndoom itself.\n"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "this Pokémon's body armor thickened. Its\n"
