...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_GAUCHO_PANTS },
    ...
    [SPECIES_DOLLIV] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_BRINEBLOOD, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ARBOLIVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SEED_SOWER, ABILITY_BRINEBLOOD, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_NACLI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_NACLSTACK}),
    },
    ...
    [SPECIES_FRIGIBAX] =
    {
        ...
        .abilities = { ABILITY_THERMAL_EXCHANGE, ABILITY_ICE_SCALES, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_GHOLDENGO, CONDITIONS({IF_BAG_ITEM_COUNT, ITEM_GIMMIGHOUL_COIN, 1})}),
    },
