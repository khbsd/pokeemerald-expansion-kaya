...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_EELEKTRIK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_VOLT_ABSORB, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLUE,
