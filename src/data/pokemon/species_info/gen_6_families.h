...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_BURN_ENTRY, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_BURN_ENTRY, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_MEOWSTIC_M},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_MEOWSTIC_F}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_STENCH, ABILITY_AROMA_VEIL, ABILITY_HEALER },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SLIGGOO},
                                {EVO_LEVEL, 30, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_WEATHER, WEATHER_RAIN})},
                                {EVO_LEVEL, 30, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_WEATHER, WEATHER_FOG})})
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG},
                                {EVO_LEVEL, 37, SPECIES_AVALUGG_HISUI,
                                    CONDITIONS({IF_IN_MAPSEC, MAPSEC_JAGGED_PASS})}),
    },
