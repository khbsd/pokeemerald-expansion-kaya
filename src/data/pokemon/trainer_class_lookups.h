const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_KAYA] = TRAINER_PIC_KAYA,
    [FACILITY_CLASS_KAYA_2] = TRAINER_PIC_KAYA,
    [FACILITY_CLASS_KAYA_3] = TRAINER_PIC_KAYA,
...
const u16 gTrainerPicToTrainerBackPic[] =
{
    ...
    [TRAINER_BACK_PIC_KAYA] = TRAINER_PIC_KAYA,
