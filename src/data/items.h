...
static const u8 sCharizarditeStoneDesc[] = _("This stone enables\n"
                                             "Charizard to Mega\n"
                                             "Evolve.");
...
static const u8 sMewtwoniteStoneDesc[] = _("This stone enables\n"
                                           "Mewtwo to Mega\n"
                                           "Evolve.");
...
// Regional Specialties
    ...
    [ITEM_LAVA_COOKIE] =
    {
        ...
        .sortType = ITEM_TYPE_STATUS_RECOVERY,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_Medicine_LavaCookie,
        .battleUsage = EFFECT_ITEM_CURE_STATUS,
        .effect = gItemEffect_FullHeal,
        .flingPower = 30,
...
// Candy
    ...
    {
        .name = ITEM_NAME("Perma Rare Candy"),
        .pluralName = ITEM_PLURAL_NAME("Perma Rare Candies"),
        .price = (I_PRICE >= GEN_7) ? 10000 : 4800,
        .description = COMPOUND_STRING(
            "Raises level by\n"
            "one. Reforms\n"
