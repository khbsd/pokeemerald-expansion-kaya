...
const u32 gObjectEventPic_KayaNormalRunning[] = INCBIN_U32("graphics/object_events/pics/people/kaya/walking.4bpp", "graphics/object_events/pics/people/kaya/running.4bpp");
