...
static const struct MenuAction MultichoiceList_LeftRight[] =
{
    {COMPOUND_STRING("Left")},
    {COMPOUND_STRING("Right")},
};
...
static const struct MenuAction MultichoiceList_MonStat[] =
{
    {COMPOUND_STRING("HP")},
    {COMPOUND_STRING("ATK")},
    {COMPOUND_STRING("DEF")},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_LEFTRIGHT]                  = MULTICHOICE(MultichoiceList_LeftRight),
    ...
    [MULTI_MON_STAT]                   = MULTICHOICE(MultichoiceList_MonStat),
