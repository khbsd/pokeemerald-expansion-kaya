...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], SPECIES_ZIGZAGOON, 7, USE_RANDOM_IVS, FALSE, 0, OT_ID_PLAYER_ID, 0, FALSE, FALSE);
    monData = TRUE;
...
void SetHiddenNature(void)
{
    ...
    SetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_NATURE, &hiddenNature);
