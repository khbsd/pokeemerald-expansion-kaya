...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(COMBEE_M),
        HOENN_TO_NATIONAL(COMBEE_F),
    ...
    HOENN_TO_NATIONAL(SALANDIT_M),
        HOENN_TO_NATIONAL(SALANDIT_F),
...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u32 personality, struct OriginalTrainerId trainerId)
{
    ...
    else if ((isGameCorner = (trainerId.method >= OT_ID_RANDOM_GAME_CORNER_BASIC
            && trainerId.method <= OT_ID_RANDOM_GAME_CORNER_MASTER))
            || trainerId.method == OT_ID_PLAYER_ID) // Player is the OT
    {
...
u32 GetBoxMonData3(struct BoxPokemon *boxMon, s32 field, u8 *data)
{
    ...
    if (field > MON_DATA_ENCRYPT_SEPARATOR)
    {
        ...
        case MON_DATA_POKERUS_STRAIN:
            retVal = (GetSubstruct3(boxMon)->pokerus >> 4);
            break;
...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    if (field > MON_DATA_ENCRYPT_SEPARATOR)
    {
        ...
        case MON_DATA_POKERUS:
            ...
            break;
        case MON_DATA_POKERUS_STRAIN:
            GetSubstruct3(boxMon)->pokerus = (*data << 4) | (GetSubstruct3(boxMon)->pokerus & POKERUS_DAYS_MASK);
            break;
        case MON_DATA_POKERUS_DAYS_LEFT:
            GetSubstruct3(boxMon)->pokerus = (*data & POKERUS_DAYS_MASK) | (GetSubstruct3(boxMon)->pokerus & POKERUS_STRAIN_MASK);
            break;
        case MON_DATA_MET_LOCATION:
...
{
    u32 bonus = 0;
    u32 badgeBoost = GetNumOwnedBadges() * B_BADGE_FRIENDSHIP_BOOST;
    ...
    bonus = (bonus * (100 + badgeBoost)) / 100;
...
u32 GetRelearnerTMMovesBox(struct BoxPokemon *boxMon, enum Move *moves)
{
    ...
    {
        if (BoxMonKnowsMove(boxMon, learnset[move])
...
bool32 HasRelearnerEggMovesBox(struct BoxPokemon *boxMon)
{
    ...
    {
        if (!BoxMonKnowsMove(boxMon, eggMoves[move]))
            return TRUE;
    }
