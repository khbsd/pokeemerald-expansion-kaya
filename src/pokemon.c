...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(SCYTHER),       HOENN_TO_NATIONAL(SCIZOR),
    ...
    HOENN_TO_NATIONAL(BUNEARY),       HOENN_TO_NATIONAL(LOPUNNY),
    ...
    HOENN_TO_NATIONAL(RIOLU),         HOENN_TO_NATIONAL(LUCARIO),
    ...
    HOENN_TO_NATIONAL(SNOVER),        HOENN_TO_NATIONAL(ABOMASNOW),
