...
{
    HOENN_TO_NATIONAL(BULBASAUR),     HOENN_TO_NATIONAL(IVYSAUR),       HOENN_TO_NATIONAL(VENUSAUR),
                                                                        HOENN_TO_NATIONAL(VENUSAUR_MEGA),
    HOENN_TO_NATIONAL(CHARMANDER),    HOENN_TO_NATIONAL(CHARMELEON),    HOENN_TO_NATIONAL(CHARIZARD),
                                                                        HOENN_TO_NATIONAL(CHARIZARD_MEGA_X),
                                                                        HOENN_TO_NATIONAL(CHARIZARD_MEGA_Y),
    HOENN_TO_NATIONAL(SQUIRTLE),      HOENN_TO_NATIONAL(WARTORTLE),     HOENN_TO_NATIONAL(BLASTOISE),
                                                                        HOENN_TO_NATIONAL(BLASTOISE_MEGA),
    HOENN_TO_NATIONAL(CATERPIE),      HOENN_TO_NATIONAL(METAPOD),       HOENN_TO_NATIONAL(BUTTERFREE),
    HOENN_TO_NATIONAL(WEEDLE),        HOENN_TO_NATIONAL(KAKUNA),        HOENN_TO_NATIONAL(BEEDRILL),
                                                                        HOENN_TO_NATIONAL(BEEDRILL_MEGA),
    HOENN_TO_NATIONAL(PIDGEY),        HOENN_TO_NATIONAL(PIDGEOTTO),     HOENN_TO_NATIONAL(PIDGEOT),
                                                                        HOENN_TO_NATIONAL(PIDGEOT_MEGA),
    HOENN_TO_NATIONAL(RATTATA),       HOENN_TO_NATIONAL(RATICATE),
    HOENN_TO_NATIONAL(SPEAROW),       HOENN_TO_NATIONAL(FEAROW),
    HOENN_TO_NATIONAL(EKANS),         HOENN_TO_NATIONAL(ARBOK),
    HOENN_TO_NATIONAL(PICHU),         HOENN_TO_NATIONAL(PIKACHU),       HOENN_TO_NATIONAL(RAICHU),
    HOENN_TO_NATIONAL(SANDSHREW),     HOENN_TO_NATIONAL(SANDSLASH),
    HOENN_TO_NATIONAL(NIDORAN_F),     HOENN_TO_NATIONAL(NIDORINA),      HOENN_TO_NATIONAL(NIDOQUEEN),
    HOENN_TO_NATIONAL(NIDORAN_M),     HOENN_TO_NATIONAL(NIDORINO),      HOENN_TO_NATIONAL(NIDOKING),
    HOENN_TO_NATIONAL(CLEFFA),        HOENN_TO_NATIONAL(CLEFAIRY),      HOENN_TO_NATIONAL(CLEFABLE),
    HOENN_TO_NATIONAL(VULPIX),        HOENN_TO_NATIONAL(NINETALES),
    HOENN_TO_NATIONAL(IGGLYBUFF),     HOENN_TO_NATIONAL(JIGGLYPUFF),    HOENN_TO_NATIONAL(WIGGLYTUFF),
    HOENN_TO_NATIONAL(ZUBAT),         HOENN_TO_NATIONAL(GOLBAT),        HOENN_TO_NATIONAL(CROBAT),
    HOENN_TO_NATIONAL(ODDISH),        HOENN_TO_NATIONAL(GLOOM),         HOENN_TO_NATIONAL(VILEPLUME),
                                                                        HOENN_TO_NATIONAL(BELLOSSOM),
                                      HOENN_TO_NATIONAL(TANGELA),       HOENN_TO_NATIONAL(TANGROWTH),
    HOENN_TO_NATIONAL(PARAS),         HOENN_TO_NATIONAL(PARASECT),
    HOENN_TO_NATIONAL(VENONAT),       HOENN_TO_NATIONAL(VENOMOTH),
    HOENN_TO_NATIONAL(DIGLETT),       HOENN_TO_NATIONAL(DUGTRIO),
    HOENN_TO_NATIONAL(MEOWTH),        HOENN_TO_NATIONAL(PERSIAN),
                                      HOENN_TO_NATIONAL(PERRSERKER),
    HOENN_TO_NATIONAL(PSYDUCK),       HOENN_TO_NATIONAL(GOLDUCK),
    HOENN_TO_NATIONAL(MANKEY),        HOENN_TO_NATIONAL(PRIMEAPE),      HOENN_TO_NATIONAL(ANNIHILAPE),
    HOENN_TO_NATIONAL(GROWLITHE),     HOENN_TO_NATIONAL(ARCANINE),
    HOENN_TO_NATIONAL(POLIWAG),       HOENN_TO_NATIONAL(POLIWHIRL),     HOENN_TO_NATIONAL(POLIWRATH),
                                                                        HOENN_TO_NATIONAL(POLITOED), 
    HOENN_TO_NATIONAL(ABRA),          HOENN_TO_NATIONAL(KADABRA),       HOENN_TO_NATIONAL(ALAKAZAM),
                                                                        HOENN_TO_NATIONAL(ALAKAZAM_MEGA),
    HOENN_TO_NATIONAL(MACHOP),        HOENN_TO_NATIONAL(MACHOKE),       HOENN_TO_NATIONAL(MACHAMP),
    HOENN_TO_NATIONAL(BELLSPROUT),    HOENN_TO_NATIONAL(WEEPINBELL),    HOENN_TO_NATIONAL(VICTREEBEL),
    HOENN_TO_NATIONAL(TENTACOOL),     HOENN_TO_NATIONAL(TENTACRUEL),
    HOENN_TO_NATIONAL(GEODUDE),       HOENN_TO_NATIONAL(GRAVELER),      HOENN_TO_NATIONAL(GOLEM),
    HOENN_TO_NATIONAL(PONYTA),        HOENN_TO_NATIONAL(RAPIDASH),
    HOENN_TO_NATIONAL(SLOWPOKE),      HOENN_TO_NATIONAL(SLOWBRO),       HOENN_TO_NATIONAL(SLOWKING),
                                      HOENN_TO_NATIONAL(SLOWBRO_MEGA),
    HOENN_TO_NATIONAL(MAGNEMITE),     HOENN_TO_NATIONAL(MAGNETON),      HOENN_TO_NATIONAL(MAGNEZONE),
    HOENN_TO_NATIONAL(FARFETCHD),     HOENN_TO_NATIONAL(SIRFETCHD),
    HOENN_TO_NATIONAL(DODUO),         HOENN_TO_NATIONAL(DODRIO),
    HOENN_TO_NATIONAL(SEEL),          HOENN_TO_NATIONAL(DEWGONG),
    HOENN_TO_NATIONAL(GRIMER),        HOENN_TO_NATIONAL(MUK),
    HOENN_TO_NATIONAL(SHELLDER),      HOENN_TO_NATIONAL(CLOYSTER),
    HOENN_TO_NATIONAL(GASTLY),        HOENN_TO_NATIONAL(HAUNTER),       HOENN_TO_NATIONAL(GENGAR),
                                                                        HOENN_TO_NATIONAL(GENGAR_MEGA),
    HOENN_TO_NATIONAL(ONIX),          HOENN_TO_NATIONAL(STEELIX),       
                                      HOENN_TO_NATIONAL(STEELIX_MEGA),
    HOENN_TO_NATIONAL(DROWZEE),       HOENN_TO_NATIONAL(HYPNO),
    HOENN_TO_NATIONAL(KRABBY),        HOENN_TO_NATIONAL(KINGLER),
    HOENN_TO_NATIONAL(VOLTORB),       HOENN_TO_NATIONAL(ELECTRODE),
    HOENN_TO_NATIONAL(EXEGGCUTE),     HOENN_TO_NATIONAL(EXEGGUTOR),
    HOENN_TO_NATIONAL(CUBONE),        HOENN_TO_NATIONAL(MAROWAK),
    HOENN_TO_NATIONAL(TYROGUE),       HOENN_TO_NATIONAL(HITMONLEE),
                                      HOENN_TO_NATIONAL(HITMONCHAN),
                                      HOENN_TO_NATIONAL(HITMONTOP),
    HOENN_TO_NATIONAL(LICKITUNG),     HOENN_TO_NATIONAL(LICKILICKY),
    HOENN_TO_NATIONAL(KOFFING),       HOENN_TO_NATIONAL(WEEZING),
    HOENN_TO_NATIONAL(RHYHORN),       HOENN_TO_NATIONAL(RHYDON),        HOENN_TO_NATIONAL(RHYPERIOR),
    HOENN_TO_NATIONAL(HAPPINY),       HOENN_TO_NATIONAL(CHANSEY),       HOENN_TO_NATIONAL(BLISSEY),
    HOENN_TO_NATIONAL(KANGASKHAN),    HOENN_TO_NATIONAL(KANGASKHAN_MEGA),
    HOENN_TO_NATIONAL(HORSEA),        HOENN_TO_NATIONAL(SEADRA),        HOENN_TO_NATIONAL(KINGDRA),
    HOENN_TO_NATIONAL(GOLDEEN),       HOENN_TO_NATIONAL(SEAKING),
    HOENN_TO_NATIONAL(STARYU),        HOENN_TO_NATIONAL(STARMIE),
    HOENN_TO_NATIONAL(MIME_JR),       HOENN_TO_NATIONAL(MR_MIME),
                                      HOENN_TO_NATIONAL(MR_RIME),
    HOENN_TO_NATIONAL(SCYTHER),       HOENN_TO_NATIONAL(SCIZOR),        HOENN_TO_NATIONAL(SCIZOR_MEGA),
                                      HOENN_TO_NATIONAL(KLEAVOR),
    HOENN_TO_NATIONAL(SMOOCHUM),      HOENN_TO_NATIONAL(JYNX),
    HOENN_TO_NATIONAL(ELEKID),        HOENN_TO_NATIONAL(ELECTABUZZ),    HOENN_TO_NATIONAL(ELECTIVIRE),
    HOENN_TO_NATIONAL(MAGBY),         HOENN_TO_NATIONAL(MAGMAR),        HOENN_TO_NATIONAL(MAGMORTAR),
    HOENN_TO_NATIONAL(PINSIR),        HOENN_TO_NATIONAL(PINSIR_MEGA),
    HOENN_TO_NATIONAL(TAUROS),
    HOENN_TO_NATIONAL(MAGIKARP),      HOENN_TO_NATIONAL(GYARADOS),      
                                      HOENN_TO_NATIONAL(GYARADOS_MEGA),
    HOENN_TO_NATIONAL(LAPRAS),
    HOENN_TO_NATIONAL(DITTO),
    HOENN_TO_NATIONAL(EEVEE),         HOENN_TO_NATIONAL(VAPOREON),
    ...
    HOENN_TO_NATIONAL(PORYGON),       HOENN_TO_NATIONAL(PORYGON2),      HOENN_TO_NATIONAL(PORYGON_Z),
    HOENN_TO_NATIONAL(OMANYTE),       HOENN_TO_NATIONAL(OMASTAR),
    HOENN_TO_NATIONAL(KABUTO),        HOENN_TO_NATIONAL(KABUTOPS),
    HOENN_TO_NATIONAL(AERODACTYL),    HOENN_TO_NATIONAL(AERODACTYL_MEGA),
    HOENN_TO_NATIONAL(MUNCHLAX),      HOENN_TO_NATIONAL(SNORLAX),
    HOENN_TO_NATIONAL(ARTICUNO),
    HOENN_TO_NATIONAL(ZAPDOS),
    HOENN_TO_NATIONAL(MOLTRES),
    HOENN_TO_NATIONAL(DRATINI),       HOENN_TO_NATIONAL(DRAGONAIR),     HOENN_TO_NATIONAL(DRAGONITE),
    HOENN_TO_NATIONAL(MEWTWO),        HOENN_TO_NATIONAL(MEWTWO_MEGA_X), 
                                      HOENN_TO_NATIONAL(MEWTWO_MEGA_Y),
    HOENN_TO_NATIONAL(MEW),
    HOENN_TO_NATIONAL(CHIKORITA),     HOENN_TO_NATIONAL(BAYLEEF),       HOENN_TO_NATIONAL(MEGANIUM),
    HOENN_TO_NATIONAL(CYNDAQUIL),     HOENN_TO_NATIONAL(QUILAVA),       HOENN_TO_NATIONAL(TYPHLOSION),
    HOENN_TO_NATIONAL(TOTODILE),      HOENN_TO_NATIONAL(CROCONAW),      HOENN_TO_NATIONAL(FERALIGATR),
    HOENN_TO_NATIONAL(SENTRET),       HOENN_TO_NATIONAL(FURRET),
    HOENN_TO_NATIONAL(HOOTHOOT),      HOENN_TO_NATIONAL(NOCTOWL),
    HOENN_TO_NATIONAL(LEDYBA),        HOENN_TO_NATIONAL(LEDIAN),
    HOENN_TO_NATIONAL(SPINARAK),      HOENN_TO_NATIONAL(ARIADOS),
    HOENN_TO_NATIONAL(CHINCHOU),      HOENN_TO_NATIONAL(LANTURN),
    HOENN_TO_NATIONAL(TOGEPI),        HOENN_TO_NATIONAL(TOGETIC),       HOENN_TO_NATIONAL(TOGEKISS),
    HOENN_TO_NATIONAL(NATU),          HOENN_TO_NATIONAL(XATU),
    HOENN_TO_NATIONAL(MAREEP),        HOENN_TO_NATIONAL(FLAAFFY),       HOENN_TO_NATIONAL(AMPHAROS),
                                                                        HOENN_TO_NATIONAL(AMPHAROS_MEGA),
    HOENN_TO_NATIONAL(AZURILL),       HOENN_TO_NATIONAL(MARILL),        HOENN_TO_NATIONAL(AZUMARILL),
    HOENN_TO_NATIONAL(BONSLY),        HOENN_TO_NATIONAL(SUDOWOODO),
    HOENN_TO_NATIONAL(HOPPIP),        HOENN_TO_NATIONAL(SKIPLOOM),      HOENN_TO_NATIONAL(JUMPLUFF),
    HOENN_TO_NATIONAL(AIPOM),         HOENN_TO_NATIONAL(AMBIPOM),
    HOENN_TO_NATIONAL(SUNKERN),       HOENN_TO_NATIONAL(SUNFLORA),
    HOENN_TO_NATIONAL(YANMA),         HOENN_TO_NATIONAL(YANMEGA),
    HOENN_TO_NATIONAL(WOOPER),        HOENN_TO_NATIONAL(QUAGSIRE),
    HOENN_TO_NATIONAL(CLODSIRE),
    HOENN_TO_NATIONAL(MURKROW),       HOENN_TO_NATIONAL(HONCHKROW),
    HOENN_TO_NATIONAL(MISDREAVUS),    HOENN_TO_NATIONAL(MISMAGIUS),
    HOENN_TO_NATIONAL(UNOWN),
    HOENN_TO_NATIONAL(WYNAUT),        HOENN_TO_NATIONAL(WOBBUFFET),
    HOENN_TO_NATIONAL(GIRAFARIG),     HOENN_TO_NATIONAL(FARIGIRAF),
    HOENN_TO_NATIONAL(PINECO),        HOENN_TO_NATIONAL(FORRETRESS),
    HOENN_TO_NATIONAL(DUNSPARCE),
    HOENN_TO_NATIONAL(GLIGAR),        HOENN_TO_NATIONAL(GLISCOR),
    HOENN_TO_NATIONAL(SNUBBULL),      HOENN_TO_NATIONAL(GRANBULL),
    HOENN_TO_NATIONAL(PINCURCHIN),    HOENN_TO_NATIONAL(QWILFISH),      HOENN_TO_NATIONAL(OVERQWIL),
    HOENN_TO_NATIONAL(SHUCKLE),
    HOENN_TO_NATIONAL(HERACROSS),     HOENN_TO_NATIONAL(HERACROSS_MEGA),
    HOENN_TO_NATIONAL(SNEASEL),       HOENN_TO_NATIONAL(WEAVILE),       HOENN_TO_NATIONAL(SNEASLER),
    HOENN_TO_NATIONAL(TEDDIURSA),     HOENN_TO_NATIONAL(URSARING),      HOENN_TO_NATIONAL(URSALUNA),
                                                                        HOENN_TO_NATIONAL(URSALUNA_BLOODMOON),
    HOENN_TO_NATIONAL(SLUGMA),        HOENN_TO_NATIONAL(MAGCARGO),
    HOENN_TO_NATIONAL(SWINUB),        HOENN_TO_NATIONAL(PILOSWINE),     HOENN_TO_NATIONAL(MAMOSWINE),
    HOENN_TO_NATIONAL(CORSOLA),       HOENN_TO_NATIONAL(CURSOLA),
    HOENN_TO_NATIONAL(REMORAID),      HOENN_TO_NATIONAL(OCTILLERY),
    HOENN_TO_NATIONAL(DELIBIRD),
    HOENN_TO_NATIONAL(MANTINE),       HOENN_TO_NATIONAL(MANTYKE),
    HOENN_TO_NATIONAL(SKARMORY),
    HOENN_TO_NATIONAL(HOUNDOUR),      HOENN_TO_NATIONAL(HOUNDOOM),      
                                      HOENN_TO_NATIONAL(HOUNDOOM_MEGA),
    HOENN_TO_NATIONAL(PHANPY),        HOENN_TO_NATIONAL(DONPHAN),
    HOENN_TO_NATIONAL(STANTLER),      HOENN_TO_NATIONAL(WYRDEER),
    ...
    HOENN_TO_NATIONAL(LARVITAR),      HOENN_TO_NATIONAL(PUPITAR),       HOENN_TO_NATIONAL(TYRANITAR),
                                                                        HOENN_TO_NATIONAL(TYRANITAR_MEGA),
    HOENN_TO_NATIONAL(LUGIA),
    HOENN_TO_NATIONAL(HO_OH),
    HOENN_TO_NATIONAL(CELEBI),
    HOENN_TO_NATIONAL(TREECKO),       HOENN_TO_NATIONAL(GROVYLE),       HOENN_TO_NATIONAL(SCEPTILE),
                                                                        HOENN_TO_NATIONAL(SCEPTILE_MEGA),
    HOENN_TO_NATIONAL(TORCHIC),       HOENN_TO_NATIONAL(COMBUSKEN),     HOENN_TO_NATIONAL(BLAZIKEN),
                                                                        HOENN_TO_NATIONAL(BLAZIKEN_MEGA),
    HOENN_TO_NATIONAL(MUDKIP),        HOENN_TO_NATIONAL(MARSHTOMP),     HOENN_TO_NATIONAL(SWAMPERT),
                                                                        HOENN_TO_NATIONAL(SWAMPERT_MEGA),
    HOENN_TO_NATIONAL(POOCHYENA),     HOENN_TO_NATIONAL(MIGHTYENA),
    HOENN_TO_NATIONAL(ZIGZAGOON),     HOENN_TO_NATIONAL(LINOONE),       HOENN_TO_NATIONAL(OBSTAGOON),
    HOENN_TO_NATIONAL(WURMPLE),       HOENN_TO_NATIONAL(SILCOON),       HOENN_TO_NATIONAL(BEAUTIFLY),
                                      HOENN_TO_NATIONAL(CASCOON),       HOENN_TO_NATIONAL(DUSTOX),
    HOENN_TO_NATIONAL(LOTAD),         HOENN_TO_NATIONAL(LOMBRE),        HOENN_TO_NATIONAL(LUDICOLO),
    HOENN_TO_NATIONAL(SEEDOT),        HOENN_TO_NATIONAL(NUZLEAF),       HOENN_TO_NATIONAL(SHIFTRY),
    HOENN_TO_NATIONAL(TAILLOW),       HOENN_TO_NATIONAL(SWELLOW),
    HOENN_TO_NATIONAL(WINGULL),       HOENN_TO_NATIONAL(PELIPPER),
    HOENN_TO_NATIONAL(RALTS),         HOENN_TO_NATIONAL(KIRLIA),        HOENN_TO_NATIONAL(GARDEVOIR),
                                                                        HOENN_TO_NATIONAL(GARDEVOIR_MEGA),
                                                                        HOENN_TO_NATIONAL(GALLADE),
                                                                        HOENN_TO_NATIONAL(GALLADE_MEGA),
    HOENN_TO_NATIONAL(SURSKIT),       HOENN_TO_NATIONAL(MASQUERAIN),
    HOENN_TO_NATIONAL(SHROOMISH),     HOENN_TO_NATIONAL(BRELOOM),
    HOENN_TO_NATIONAL(SLAKOTH),       HOENN_TO_NATIONAL(VIGOROTH),      HOENN_TO_NATIONAL(SLAKING),
    HOENN_TO_NATIONAL(NINCADA),       HOENN_TO_NATIONAL(NINJASK),
                                      HOENN_TO_NATIONAL(SHEDINJA),
    HOENN_TO_NATIONAL(WHISMUR),       HOENN_TO_NATIONAL(LOUDRED),       HOENN_TO_NATIONAL(EXPLOUD),
    HOENN_TO_NATIONAL(MAKUHITA),      HOENN_TO_NATIONAL(HARIYAMA),
    HOENN_TO_NATIONAL(NOSEPASS),      HOENN_TO_NATIONAL(PROBOPASS),
    HOENN_TO_NATIONAL(SKITTY),        HOENN_TO_NATIONAL(DELCATTY),
    HOENN_TO_NATIONAL(SABLEYE),       HOENN_TO_NATIONAL(SABLEYE_MEGA),
    HOENN_TO_NATIONAL(MAWILE),        HOENN_TO_NATIONAL(MAWILE_MEGA),
    HOENN_TO_NATIONAL(ARON),          HOENN_TO_NATIONAL(LAIRON),        HOENN_TO_NATIONAL(AGGRON),
                                                                        HOENN_TO_NATIONAL(AGGRON_MEGA),
    HOENN_TO_NATIONAL(MEDITITE),      HOENN_TO_NATIONAL(MEDICHAM),
                                      HOENN_TO_NATIONAL(MEDICHAM_MEGA),
    HOENN_TO_NATIONAL(ELECTRIKE),     HOENN_TO_NATIONAL(MANECTRIC),
    ...
    HOENN_TO_NATIONAL(BUDEW),         HOENN_TO_NATIONAL(ROSELIA),       HOENN_TO_NATIONAL(ROSERADE),
    HOENN_TO_NATIONAL(GULPIN),        HOENN_TO_NATIONAL(SWALOT),
    HOENN_TO_NATIONAL(CARVANHA),      HOENN_TO_NATIONAL(SHARPEDO),
                                      HOENN_TO_NATIONAL(SHARPEDO_MEGA),
    HOENN_TO_NATIONAL(WAILMER),       HOENN_TO_NATIONAL(WAILORD),
    HOENN_TO_NATIONAL(NUMEL),         HOENN_TO_NATIONAL(CAMERUPT),
                                      HOENN_TO_NATIONAL(CAMERUPT_MEGA),
    HOENN_TO_NATIONAL(TORKOAL),       HOENN_TO_NATIONAL(TURTONATOR),
    HOENN_TO_NATIONAL(SPOINK),        HOENN_TO_NATIONAL(GRUMPIG),
    HOENN_TO_NATIONAL(SPINDA),        
    HOENN_TO_NATIONAL(TRAPINCH),      HOENN_TO_NATIONAL(VIBRAVA),       HOENN_TO_NATIONAL(FLYGON),
    HOENN_TO_NATIONAL(CACNEA),        HOENN_TO_NATIONAL(CACTURNE),
    HOENN_TO_NATIONAL(SWABLU),        HOENN_TO_NATIONAL(ALTARIA),
    ...
    HOENN_TO_NATIONAL(BARBOACH),      HOENN_TO_NATIONAL(WHISCASH),
    HOENN_TO_NATIONAL(CORPHISH),
    HOENN_TO_NATIONAL(CRAWDAUNT),
    HOENN_TO_NATIONAL(BALTOY),        HOENN_TO_NATIONAL(CLAYDOL),
    HOENN_TO_NATIONAL(LILEEP),        HOENN_TO_NATIONAL(CRADILY),
    HOENN_TO_NATIONAL(ANORITH),       HOENN_TO_NATIONAL(ARMALDO),
    HOENN_TO_NATIONAL(FEEBAS),        HOENN_TO_NATIONAL(MILOTIC),
    HOENN_TO_NATIONAL(CASTFORM),
    HOENN_TO_NATIONAL(KECLEON),
    HOENN_TO_NATIONAL(SHUPPET),       HOENN_TO_NATIONAL(BANETTE),
                                      HOENN_TO_NATIONAL(BANETTE_MEGA),
    HOENN_TO_NATIONAL(DUSKULL),       HOENN_TO_NATIONAL(DUSCLOPS),      HOENN_TO_NATIONAL(DUSKNOIR),
    HOENN_TO_NATIONAL(TROPIUS),
    HOENN_TO_NATIONAL(CHINGLING),     HOENN_TO_NATIONAL(CHIMECHO),
    HOENN_TO_NATIONAL(ABSOL),         HOENN_TO_NATIONAL(ABSOL_MEGA),
    HOENN_TO_NATIONAL(SNORUNT),       HOENN_TO_NATIONAL(GLALIE),
                                      HOENN_TO_NATIONAL(GLALIE_MEGA),
                                      HOENN_TO_NATIONAL(FROSLASS),
    HOENN_TO_NATIONAL(SPHEAL),        HOENN_TO_NATIONAL(SEALEO),        HOENN_TO_NATIONAL(WALREIN),
    HOENN_TO_NATIONAL(CLAMPERL),      HOENN_TO_NATIONAL(HUNTAIL),
                                      HOENN_TO_NATIONAL(GOREBYSS),
    HOENN_TO_NATIONAL(RELICANTH),
    HOENN_TO_NATIONAL(LUVDISC),
    HOENN_TO_NATIONAL(BAGON),         HOENN_TO_NATIONAL(SHELGON),       HOENN_TO_NATIONAL(SALAMENCE),
                                                                        HOENN_TO_NATIONAL(SALAMENCE_MEGA),
    HOENN_TO_NATIONAL(BELDUM),        HOENN_TO_NATIONAL(METANG),        HOENN_TO_NATIONAL(METAGROSS),
                                                                        HOENN_TO_NATIONAL(METAGROSS_MEGA),
    HOENN_TO_NATIONAL(REGIROCK),
    HOENN_TO_NATIONAL(REGICE),
    HOENN_TO_NATIONAL(REGISTEEL),
    HOENN_TO_NATIONAL(LATIAS),        HOENN_TO_NATIONAL(LATIAS_MEGA),
    HOENN_TO_NATIONAL(LATIOS),        HOENN_TO_NATIONAL(LATIOS_MEGA),
    HOENN_TO_NATIONAL(KYOGRE),        HOENN_TO_NATIONAL(KYOGRE_PRIMAL),
    HOENN_TO_NATIONAL(GROUDON),       HOENN_TO_NATIONAL(GROUDON_PRIMAL),
    HOENN_TO_NATIONAL(RAYQUAZA),      HOENN_TO_NATIONAL(RAYQUAZA_MEGA),
    HOENN_TO_NATIONAL(JIRACHI),
    HOENN_TO_NATIONAL(DEOXYS),
    HOENN_TO_NATIONAL(TURTWIG),       HOENN_TO_NATIONAL(GROTLE),        HOENN_TO_NATIONAL(TORTERRA),
    HOENN_TO_NATIONAL(CHIMCHAR),      HOENN_TO_NATIONAL(MONFERNO),      HOENN_TO_NATIONAL(INFERNAPE),
    HOENN_TO_NATIONAL(PIPLUP),        HOENN_TO_NATIONAL(PRINPLUP),      HOENN_TO_NATIONAL(EMPOLEON),
    HOENN_TO_NATIONAL(STARLY),        HOENN_TO_NATIONAL(STARAVIA),      HOENN_TO_NATIONAL(STARAPTOR),
    HOENN_TO_NATIONAL(BIDOOF),        HOENN_TO_NATIONAL(BIBAREL),
    HOENN_TO_NATIONAL(KRICKETOT),     HOENN_TO_NATIONAL(KRICKETUNE),
    HOENN_TO_NATIONAL(SHINX),         HOENN_TO_NATIONAL(LUXIO),         HOENN_TO_NATIONAL(LUXRAY),
    HOENN_TO_NATIONAL(CRANIDOS),      HOENN_TO_NATIONAL(RAMPARDOS),
    HOENN_TO_NATIONAL(SHIELDON),      HOENN_TO_NATIONAL(BASTIODON),
    HOENN_TO_NATIONAL(BURMY),         HOENN_TO_NATIONAL(WORMADAM),      HOENN_TO_NATIONAL(MOTHIM),
    HOENN_TO_NATIONAL(COMBEE),        HOENN_TO_NATIONAL(VESPIQUEN),
    HOENN_TO_NATIONAL(PACHIRISU),
    HOENN_TO_NATIONAL(BUIZEL),        HOENN_TO_NATIONAL(FLOATZEL),
    HOENN_TO_NATIONAL(CHERUBI),       HOENN_TO_NATIONAL(CHERRIM),
    HOENN_TO_NATIONAL(SHELLOS),       HOENN_TO_NATIONAL(GASTRODON),
    HOENN_TO_NATIONAL(DRIFLOON),      HOENN_TO_NATIONAL(DRIFBLIM),
    HOENN_TO_NATIONAL(BUNEARY),       HOENN_TO_NATIONAL(LOPUNNY),       HOENN_TO_NATIONAL(LOPUNNY_MEGA),
    HOENN_TO_NATIONAL(GLAMEOW),       HOENN_TO_NATIONAL(PURUGLY),
    HOENN_TO_NATIONAL(STUNKY),        HOENN_TO_NATIONAL(SKUNTANK),
    HOENN_TO_NATIONAL(BRONZOR),       HOENN_TO_NATIONAL(BRONZONG),
    HOENN_TO_NATIONAL(CHATOT),
    HOENN_TO_NATIONAL(SPIRITOMB),
    HOENN_TO_NATIONAL(GIBLE),         HOENN_TO_NATIONAL(GABITE),        HOENN_TO_NATIONAL(GARCHOMP),
                                                                        HOENN_TO_NATIONAL(GARCHOMP_MEGA),
    HOENN_TO_NATIONAL(RIOLU),         HOENN_TO_NATIONAL(LUCARIO),       HOENN_TO_NATIONAL(LUCARIO_MEGA),
    HOENN_TO_NATIONAL(HIPPOPOTAS),    HOENN_TO_NATIONAL(HIPPOWDON),
    HOENN_TO_NATIONAL(SKORUPI),       HOENN_TO_NATIONAL(DRAPION),
    HOENN_TO_NATIONAL(CROAGUNK),      HOENN_TO_NATIONAL(TOXICROAK),
    HOENN_TO_NATIONAL(CARNIVINE),
    HOENN_TO_NATIONAL(FINNEON),       HOENN_TO_NATIONAL(LUMINEON),
    HOENN_TO_NATIONAL(SNOVER),        HOENN_TO_NATIONAL(ABOMASNOW),     HOENN_TO_NATIONAL(ABOMASNOW_MEGA),
    ...
    HOENN_TO_NATIONAL(PHIONE),        HOENN_TO_NATIONAL(MANAPHY),
    HOENN_TO_NATIONAL(DARKRAI),
    HOENN_TO_NATIONAL(SHAYMIN),
    HOENN_TO_NATIONAL(ARCEUS),
    HOENN_TO_NATIONAL(SNIVY),         HOENN_TO_NATIONAL(SERVINE),       HOENN_TO_NATIONAL(SERPERIOR),
    HOENN_TO_NATIONAL(TEPIG),         HOENN_TO_NATIONAL(PIGNITE),       HOENN_TO_NATIONAL(EMBOAR),
    HOENN_TO_NATIONAL(OSHAWOTT),      HOENN_TO_NATIONAL(DEWOTT),        HOENN_TO_NATIONAL(SAMUROTT),
    HOENN_TO_NATIONAL(LILLIPUP),      HOENN_TO_NATIONAL(HERDIER),       HOENN_TO_NATIONAL(STOUTLAND),
    HOENN_TO_NATIONAL(ROGGENROLA),    HOENN_TO_NATIONAL(BOLDORE),       HOENN_TO_NATIONAL(GIGALITH),
    HOENN_TO_NATIONAL(TIMBURR),       HOENN_TO_NATIONAL(GURDURR),       HOENN_TO_NATIONAL(CONKELDURR),
    HOENN_TO_NATIONAL(TYMPOLE),       HOENN_TO_NATIONAL(PALPITOAD),     HOENN_TO_NATIONAL(SEISMITOAD),
    HOENN_TO_NATIONAL(SEWADDLE),      HOENN_TO_NATIONAL(SWADLOON),      HOENN_TO_NATIONAL(LEAVANNY),
    HOENN_TO_NATIONAL(VENIPEDE),      HOENN_TO_NATIONAL(WHIRLIPEDE),    HOENN_TO_NATIONAL(SCOLIPEDE),
    HOENN_TO_NATIONAL(COTTONEE),      HOENN_TO_NATIONAL(WHIMSICOTT),
    HOENN_TO_NATIONAL(SANDILE),       HOENN_TO_NATIONAL(KROKOROK),      HOENN_TO_NATIONAL(KROOKODILE),
    HOENN_TO_NATIONAL(DWEBBLE),       HOENN_TO_NATIONAL(CRUSTLE),       HOENN_TO_NATIONAL(SCRAGGY),
    HOENN_TO_NATIONAL(SCRAFTY),
    HOENN_TO_NATIONAL(YAMASK),        HOENN_TO_NATIONAL(COFAGRIGUS),
                                      HOENN_TO_NATIONAL(RUNERIGUS),
    HOENN_TO_NATIONAL(TIRTOUGA),      HOENN_TO_NATIONAL(CARRACOSTA),
    HOENN_TO_NATIONAL(ARCHEN),        HOENN_TO_NATIONAL(ARCHEOPS),
    HOENN_TO_NATIONAL(ZORUA),         HOENN_TO_NATIONAL(ZOROARK),
    HOENN_TO_NATIONAL(GOTHITA),       HOENN_TO_NATIONAL(GOTHORITA),     HOENN_TO_NATIONAL(GOTHITELLE),
    HOENN_TO_NATIONAL(SOLOSIS),       HOENN_TO_NATIONAL(DUOSION),       HOENN_TO_NATIONAL(REUNICLUS),
    HOENN_TO_NATIONAL(FRILLISH),      HOENN_TO_NATIONAL(JELLICENT),
    HOENN_TO_NATIONAL(JOLTIK),        HOENN_TO_NATIONAL(GALVANTULA),
    HOENN_TO_NATIONAL(KLINK),         HOENN_TO_NATIONAL(KLANG),         HOENN_TO_NATIONAL(KLINKLANG),
    HOENN_TO_NATIONAL(TYNAMO),        HOENN_TO_NATIONAL(EELEKTRIK),     HOENN_TO_NATIONAL(EELEKTROSS),
    HOENN_TO_NATIONAL(LITWICK),       HOENN_TO_NATIONAL(LAMPENT),       HOENN_TO_NATIONAL(CHANDELURE),
    HOENN_TO_NATIONAL(AXEW),          HOENN_TO_NATIONAL(FRAXURE),       HOENN_TO_NATIONAL(HAXORUS),
    HOENN_TO_NATIONAL(CUBCHOO),       HOENN_TO_NATIONAL(BEARTIC),
    HOENN_TO_NATIONAL(GOLETT),        HOENN_TO_NATIONAL(GOLURK),
    HOENN_TO_NATIONAL(PAWNIARD),      HOENN_TO_NATIONAL(BISHARP),       HOENN_TO_NATIONAL(KINGAMBIT),
    HOENN_TO_NATIONAL(DEINO),         HOENN_TO_NATIONAL(ZWEILOUS),      HOENN_TO_NATIONAL(HYDREIGON),
    HOENN_TO_NATIONAL(LARVESTA),      HOENN_TO_NATIONAL(VOLCARONA),
    HOENN_TO_NATIONAL(CHESPIN),       HOENN_TO_NATIONAL(QUILLADIN),     HOENN_TO_NATIONAL(CHESNAUGHT),
    HOENN_TO_NATIONAL(FENNEKIN),      HOENN_TO_NATIONAL(BRAIXEN),       HOENN_TO_NATIONAL(DELPHOX),
    HOENN_TO_NATIONAL(FROAKIE),       HOENN_TO_NATIONAL(FROGADIER),     HOENN_TO_NATIONAL(GRENINJA),
    HOENN_TO_NATIONAL(BUNNELBY),      HOENN_TO_NATIONAL(DIGGERSBY),
    HOENN_TO_NATIONAL(FLETCHLING),    HOENN_TO_NATIONAL(FLETCHINDER),   HOENN_TO_NATIONAL(TALONFLAME),
    HOENN_TO_NATIONAL(SCATTERBUG),    HOENN_TO_NATIONAL(SPEWPA),        HOENN_TO_NATIONAL(VIVILLON),
    HOENN_TO_NATIONAL(FLABEBE),       HOENN_TO_NATIONAL(FLOETTE),       HOENN_TO_NATIONAL(FLORGES),
    HOENN_TO_NATIONAL(SKIDDO),        HOENN_TO_NATIONAL(GOGOAT),
    HOENN_TO_NATIONAL(PANCHAM),       HOENN_TO_NATIONAL(PANGORO),
    HOENN_TO_NATIONAL(SPRITZEE),      HOENN_TO_NATIONAL(AROMATISSE),
    HOENN_TO_NATIONAL(INKAY),         HOENN_TO_NATIONAL(MALAMAR),
    HOENN_TO_NATIONAL(BINACLE),       HOENN_TO_NATIONAL(BARBARACLE),
    HOENN_TO_NATIONAL(SKRELP),        HOENN_TO_NATIONAL(DRAGALGE),
    HOENN_TO_NATIONAL(AMAURA),        HOENN_TO_NATIONAL(AURORUS),
    HOENN_TO_NATIONAL(CARBINK),       HOENN_TO_NATIONAL(DIANCIE),
                                      HOENN_TO_NATIONAL(DIANCIE_MEGA),
    HOENN_TO_NATIONAL(GOOMY),         HOENN_TO_NATIONAL(SLIGGOO),       HOENN_TO_NATIONAL(GOODRA),
    HOENN_TO_NATIONAL(PHANTUMP),      HOENN_TO_NATIONAL(TREVENANT),
    HOENN_TO_NATIONAL(PUMPKABOO),     HOENN_TO_NATIONAL(GOURGEIST),
    HOENN_TO_NATIONAL(BERGMITE),      HOENN_TO_NATIONAL(AVALUGG),
    HOENN_TO_NATIONAL(NOIBAT),        HOENN_TO_NATIONAL(NOIVERN),
    HOENN_TO_NATIONAL(ROWLET),        HOENN_TO_NATIONAL(DARTRIX),       HOENN_TO_NATIONAL(DECIDUEYE),
    HOENN_TO_NATIONAL(LITTEN),        HOENN_TO_NATIONAL(TORRACAT),      HOENN_TO_NATIONAL(INCINEROAR),
    HOENN_TO_NATIONAL(POPPLIO),       HOENN_TO_NATIONAL(BRIONNE),       HOENN_TO_NATIONAL(PRIMARINA),
    HOENN_TO_NATIONAL(PIKIPEK),       HOENN_TO_NATIONAL(TRUMBEAK),      HOENN_TO_NATIONAL(TOUCANNON),
    HOENN_TO_NATIONAL(GRUBBIN),       HOENN_TO_NATIONAL(CHARJABUG),     HOENN_TO_NATIONAL(VIKAVOLT),
    HOENN_TO_NATIONAL(ROCKRUFF),      HOENN_TO_NATIONAL(LYCANROC),
    HOENN_TO_NATIONAL(MAREANIE),      HOENN_TO_NATIONAL(TOXAPEX),
    HOENN_TO_NATIONAL(DEWPIDER),      HOENN_TO_NATIONAL(ARAQUANID),
    HOENN_TO_NATIONAL(FOMANTIS),      HOENN_TO_NATIONAL(LURANTIS),
    HOENN_TO_NATIONAL(SALANDIT_M),    HOENN_TO_NATIONAL(SALANDIT_F),    HOENN_TO_NATIONAL(SALAZZLE),
    HOENN_TO_NATIONAL(BOUNSWEET),     HOENN_TO_NATIONAL(STEENEE),       HOENN_TO_NATIONAL(TSAREENA),
    HOENN_TO_NATIONAL(WIMPOD),        HOENN_TO_NATIONAL(GOLISOPOD),
    HOENN_TO_NATIONAL(SANDYGAST),     HOENN_TO_NATIONAL(PALOSSAND),
    HOENN_TO_NATIONAL(TYPE_NULL),     HOENN_TO_NATIONAL(SILVALLY),
    HOENN_TO_NATIONAL(TOGEDEMARU),
    HOENN_TO_NATIONAL(JANGMO_O),      HOENN_TO_NATIONAL(HAKAMO_O),      HOENN_TO_NATIONAL(KOMMO_O),
    HOENN_TO_NATIONAL(COSMOG),        HOENN_TO_NATIONAL(COSMOEM),       HOENN_TO_NATIONAL(SOLGALEO),
                                                                        HOENN_TO_NATIONAL(LUNALA),
    HOENN_TO_NATIONAL(MARSHADOW),
    HOENN_TO_NATIONAL(MELTAN),        HOENN_TO_NATIONAL(MELMETAL),
    HOENN_TO_NATIONAL(GROOKEY),       HOENN_TO_NATIONAL(THWACKEY),      HOENN_TO_NATIONAL(RILLABOOM),
    HOENN_TO_NATIONAL(SCORBUNNY),     HOENN_TO_NATIONAL(RABOOT),        HOENN_TO_NATIONAL(CINDERACE),
    HOENN_TO_NATIONAL(SOBBLE),        HOENN_TO_NATIONAL(DRIZZILE),      HOENN_TO_NATIONAL(INTELEON),
    HOENN_TO_NATIONAL(ROOKIDEE),      HOENN_TO_NATIONAL(CORVISQUIRE),   HOENN_TO_NATIONAL(CORVIKNIGHT),
    HOENN_TO_NATIONAL(BLIPBUG),       HOENN_TO_NATIONAL(DOTTLER),       HOENN_TO_NATIONAL(ORBEETLE),
    HOENN_TO_NATIONAL(CHEWTLE),       HOENN_TO_NATIONAL(DREDNAW),
    HOENN_TO_NATIONAL(YAMPER),        HOENN_TO_NATIONAL(BOLTUND),
    HOENN_TO_NATIONAL(ROLYCOLY),      HOENN_TO_NATIONAL(CARKOL),        HOENN_TO_NATIONAL(COALOSSAL),
    HOENN_TO_NATIONAL(APPLIN),        HOENN_TO_NATIONAL(FLAPPLE),       HOENN_TO_NATIONAL(APPLETUN),
                                      HOENN_TO_NATIONAL(DIPPLIN),       HOENN_TO_NATIONAL(HYDRAPPLE),
    HOENN_TO_NATIONAL(ARROKUDA),      HOENN_TO_NATIONAL(BARRASKEWDA),
    HOENN_TO_NATIONAL(SIZZLIPEDE),    HOENN_TO_NATIONAL(CENTISKORCH),
    HOENN_TO_NATIONAL(CLOBBOPUS),     HOENN_TO_NATIONAL(GRAPPLOCT),
    HOENN_TO_NATIONAL(IMPIDIMP),      HOENN_TO_NATIONAL(MORGREM),       HOENN_TO_NATIONAL(GRIMMSNARL),
    HOENN_TO_NATIONAL(SNOM),          HOENN_TO_NATIONAL(FROSMOTH),
    HOENN_TO_NATIONAL(CUFANT),        HOENN_TO_NATIONAL(COPPERAJAH),
    HOENN_TO_NATIONAL(DREEPY),        HOENN_TO_NATIONAL(DRAKLOAK),      HOENN_TO_NATIONAL(DRAGAPULT),
    HOENN_TO_NATIONAL(KUBFU),         HOENN_TO_NATIONAL(URSHIFU),
    HOENN_TO_NATIONAL(SPRIGATITO),    HOENN_TO_NATIONAL(FLORAGATO),     HOENN_TO_NATIONAL(MEOWSCARADA),
    HOENN_TO_NATIONAL(FUECOCO),       HOENN_TO_NATIONAL(CROCALOR),      HOENN_TO_NATIONAL(SKELEDIRGE),
    HOENN_TO_NATIONAL(QUAXLY),        HOENN_TO_NATIONAL(QUAXWELL),      HOENN_TO_NATIONAL(QUAQUAVAL),
    HOENN_TO_NATIONAL(PAWMI),         HOENN_TO_NATIONAL(PAWMO),         HOENN_TO_NATIONAL(PAWMOT),
    HOENN_TO_NATIONAL(SMOLIV),        HOENN_TO_NATIONAL(DOLLIV),        HOENN_TO_NATIONAL(ARBOLIVA),
    HOENN_TO_NATIONAL(NACLI),         HOENN_TO_NATIONAL(NACLSTACK),     HOENN_TO_NATIONAL(GARGANACL),
    HOENN_TO_NATIONAL(CHARCADET),     HOENN_TO_NATIONAL(ARMAROUGE),
                                      HOENN_TO_NATIONAL(CERULEDGE),
    HOENN_TO_NATIONAL(TADBULB),       HOENN_TO_NATIONAL(BELLIBOLT),
    HOENN_TO_NATIONAL(WATTREL),       HOENN_TO_NATIONAL(KILOWATTREL),
    HOENN_TO_NATIONAL(TOEDSCOOL),     HOENN_TO_NATIONAL(TOEDSCRUEL),
    HOENN_TO_NATIONAL(TINKATINK),     HOENN_TO_NATIONAL(TINKATUFF),     HOENN_TO_NATIONAL(TINKATON),
    HOENN_TO_NATIONAL(WIGLETT),       HOENN_TO_NATIONAL(WUGTRIO),
    HOENN_TO_NATIONAL(GREAVARD),      HOENN_TO_NATIONAL(HOUNDSTONE),
    HOENN_TO_NATIONAL(GLIMMET),       HOENN_TO_NATIONAL(GLIMMORA),
    HOENN_TO_NATIONAL(CETODDLE),      HOENN_TO_NATIONAL(CETITAN),
    HOENN_TO_NATIONAL(FRIGIBAX),      HOENN_TO_NATIONAL(ARCTIBAX),      HOENN_TO_NATIONAL(BAXCALIBUR),
    HOENN_TO_NATIONAL(GIMMIGHOUL),    HOENN_TO_NATIONAL(GHOLDENGO),
};
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_KAYA] = {
        .tileTag = TAG_NONE,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Kaya,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
                            ...
                            for (temp2 = 0; (signed)(temp2) < (signed)(MAX_MON_MOVES); temp2++)
                            {
                                ...
                                if (dataUnsigned != ppBonus)
                                {
                                    ...
                                    if (gMain.inBattle && battler != MAX_BATTLERS_COUNT)
                                        CopyPartyMonToBattleData(battler, GetPartyIdFromBattlePartyId(gBattlerPartyIndexes[battler]), TRUE);
                                    retVal = FALSE;
                                }
                            }
                            itemEffectParam++;
