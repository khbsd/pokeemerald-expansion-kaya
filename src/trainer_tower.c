...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_SUPER_NERD,       FACILITY_CLASS_HEX_MANIAC,          BUTCHY},
    ...
    {OBJ_EVENT_GFX_SUPER_NERD,       FACILITY_CLASS_BUG_MANIAC,          BUTCHY},
    ...
    {OBJ_EVENT_GFX_BATTLE_GIRL,      FACILITY_CLASS_BATTLE_GIRL,         FEMME},
    ...
    {OBJ_EVENT_GFX_SUPER_NERD,       FACILITY_CLASS_POKEMANIAC,          BUTCHY},
    {OBJ_EVENT_GFX_SUPER_NERD,       FACILITY_CLASS_SUPER_NERD_FRLG,     BUTCHY},
    {OBJ_EVENT_GFX_HIKER_FRLG,       FACILITY_CLASS_HIKER_FRLG,          BUTCHY},
    {OBJ_EVENT_GFX_BIKER,            FACILITY_CLASS_BIKER_FRLG,          BUTCHY},
    {OBJ_EVENT_GFX_SUPER_NERD,       FACILITY_CLASS_BURGLAR_FRLG,        BUTCHY},
    ...
    {OBJ_EVENT_GFX_BLACKBELT,        FACILITY_CLASS_BLACK_BELT_FRLG,     BUTCHY},
    ...
    {OBJ_EVENT_GFX_BATTLE_GIRL,      FACILITY_CLASS_CRUSH_GIRL_FRLG,     FEMME},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_BATTLE_GIRL,      OBJ_EVENT_GFX_BATTLE_GIRL,      FACILITY_CLASS_CRUSH_KIN_FRLG,    FEMME,  BUTCHY},
