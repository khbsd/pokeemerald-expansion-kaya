...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_BEAUTY_FRLG,    OBJ_EVENT_GFX_WOMAN_1_FRLG,   FACILITY_CLASS_SR_AND_JR,       FEMME, FEMME},
    {OBJ_EVENT_GFX_OLD_MAN_1,      OBJ_EVENT_GFX_OLD_WOMAN_FRLG, FACILITY_CLASS_OLD_COUPLE,        BUTCHY, FEMME},
    ...
    {OBJ_EVENT_GFX_BEAUTY_FRLG,    OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_YOUNG_COUPLE_FRLG,    FEMME,   BUTCHY},
    {OBJ_EVENT_GFX_BATTLE_GIRL,    OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_CRUSH_KIN_FRLG,       FEMME,   BUTCHY},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND, OBJ_EVENT_GFX_TUBER_M_LAND,   FACILITY_CLASS_SIS_AND_BRO_FRLG,     FEMME,   BUTCHY}
};
