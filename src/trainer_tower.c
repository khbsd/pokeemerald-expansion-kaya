...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG,       FACILITY_CLASS_HEX_MANIAC,          BUTCHY},
    {OBJ_EVENT_GFX_BOY,                    FACILITY_CLASS_RICH_BOY,            BUTCHY},
    {OBJ_EVENT_GFX_ROCKER,                 FACILITY_CLASS_GUITARIST,           BUTCHY},
    {OBJ_EVENT_GFX_ROCKER,                 FACILITY_CLASS_KINDLER,             BUTCHY},
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG,       FACILITY_CLASS_BUG_MANIAC,          BUTCHY},
    {OBJ_EVENT_GFX_BOY,                    FACILITY_CLASS_SCHOOL_KID_M,        BUTCHY},
    {OBJ_EVENT_GFX_WOMAN_1_FRLG,           FACILITY_CLASS_SCHOOL_KID_F,        FEMME},
    {OBJ_EVENT_GFX_BALDING_MAN,            FACILITY_CLASS_POKEFAN_M,           BUTCHY},
    {OBJ_EVENT_GFX_WOMAN_3_FRLG,           FACILITY_CLASS_POKEFAN_F,           FEMME},
    {OBJ_EVENT_GFX_OLD_MAN_1,              FACILITY_CLASS_EXPERT_M,            BUTCHY},
    {OBJ_EVENT_GFX_OLD_WOMAN_FRLG,         FACILITY_CLASS_EXPERT_F,            FEMME},
    {OBJ_EVENT_GFX_COOLTRAINER_M,          FACILITY_CLASS_DRAGON_TAMER,        BUTCHY},
    {OBJ_EVENT_GFX_LITTLE_BOY_FRLG,        FACILITY_CLASS_NINJA_BOY,           BUTCHY},
    {OBJ_EVENT_GFX_CRUSH_GIRL,             FACILITY_CLASS_BATTLE_GIRL,         FEMME},
    {OBJ_EVENT_GFX_BEAUTY_FRLG,            FACILITY_CLASS_PARASOL_LADY,        FEMME},
    {OBJ_EVENT_GFX_FAT_MAN_FRLG,           FACILITY_CLASS_COLLECTOR,           BUTCHY},
    {OBJ_EVENT_GFX_YOUNGSTER_FRLG,         FACILITY_CLASS_YOUNGSTER_FRLG,      BUTCHY},
    {OBJ_EVENT_GFX_BUG_CATCHER_FRLG,       FACILITY_CLASS_BUG_CATCHER_FRLG,    BUTCHY},
    {OBJ_EVENT_GFX_LASS_FRLG,              FACILITY_CLASS_LASS_FRLG,           FEMME},
    {OBJ_EVENT_GFX_SAILOR_FRLG,            FACILITY_CLASS_SAILOR_FRLG,         BUTCHY},
    {OBJ_EVENT_GFX_CAMPER_FRLG,            FACILITY_CLASS_CAMPER_FRLG,         BUTCHY},
    {OBJ_EVENT_GFX_PICNICKER_FRLG,         FACILITY_CLASS_PICNICKER_FRLG,      FEMME},
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG,       FACILITY_CLASS_POKEMANIAC,          BUTCHY},
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG,       FACILITY_CLASS_SUPER_NERD_FRLG,     BUTCHY},
    {OBJ_EVENT_GFX_HIKER_FRLG,             FACILITY_CLASS_HIKER_FRLG,          BUTCHY},
    {OBJ_EVENT_GFX_BIKER,                  FACILITY_CLASS_BIKER_FRLG,          BUTCHY},
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG,       FACILITY_CLASS_BURGLAR_FRLG,        BUTCHY},
    {OBJ_EVENT_GFX_BALDING_MAN,            FACILITY_CLASS_ENGINEER_FRLG,       BUTCHY},
    {OBJ_EVENT_GFX_FISHER,                 FACILITY_CLASS_FISHERMAN_FRLG,      BUTCHY},
    {OBJ_EVENT_GFX_SWIMMER_M_LAND,         FACILITY_CLASS_SWIMMER_M_FRLG,      BUTCHY},
    {OBJ_EVENT_GFX_BIKER,                  FACILITY_CLASS_CUE_BALL_FRLG,       BUTCHY},
    {OBJ_EVENT_GFX_BEAUTY_FRLG,            FACILITY_CLASS_BEAUTY_FRLG,         FEMME},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND,         FACILITY_CLASS_SWIMMER_F_FRLG,      FEMME},
    {OBJ_EVENT_GFX_BOY,                    FACILITY_CLASS_PSYCHIC_M_FRLG,      BUTCHY},
    {OBJ_EVENT_GFX_ROCKER,                 FACILITY_CLASS_ROCKER_FRLG,         BUTCHY},
    {OBJ_EVENT_GFX_ROCKER,                 FACILITY_CLASS_JUGGLER_FRLG,        BUTCHY},
    {OBJ_EVENT_GFX_ROCKER,                 FACILITY_CLASS_BIRD_KEEPER,         BUTCHY},
    {OBJ_EVENT_GFX_BLACK_BELT_FRLG,        FACILITY_CLASS_BLACK_BELT_FRLG,     BUTCHY},
    {OBJ_EVENT_GFX_SCIENTIST,              FACILITY_CLASS_SCIENTIST_FRLG,      BUTCHY},
    {OBJ_EVENT_GFX_COOLTRAINER_M,          FACILITY_CLASS_COOLTRAINER_M_FRLG,  BUTCHY},
    {OBJ_EVENT_GFX_COOLTRAINER_F,          FACILITY_CLASS_COOLTRAINER_F_FRLG,  FEMME},
    {OBJ_EVENT_GFX_GENTLEMAN,              FACILITY_CLASS_GENTLEMAN_FRLG,      BUTCHY},
    {OBJ_EVENT_GFX_WOMAN_1_FRLG,           FACILITY_CLASS_PSYCHIC_F_FRLG,      FEMME},
    {OBJ_EVENT_GFX_CRUSH_GIRL,             FACILITY_CLASS_CRUSH_GIRL_FRLG,     FEMME},
    {OBJ_EVENT_GFX_TUBER_F_FRLG,           FACILITY_CLASS_TUBER_FRLG,          FEMME},
    {OBJ_EVENT_GFX_WOMAN_2_FRLG,           FACILITY_CLASS_PKMN_BREEDER_FRLG,   FEMME},
    {OBJ_EVENT_GFX_CAMPER_FRLG,            FACILITY_CLASS_PKMN_RANGER_M_FRLG,  BUTCHY},
    {OBJ_EVENT_GFX_PICNICKER_FRLG,         FACILITY_CLASS_PKMN_RANGER_F_FRLG,  FEMME},
    {OBJ_EVENT_GFX_WOMAN_2_FRLG,           FACILITY_CLASS_AROMA_LADY_FRLG,     FEMME},
    {OBJ_EVENT_GFX_HIKER_FRLG,             FACILITY_CLASS_RUIN_MANIAC,         BUTCHY},
    {OBJ_EVENT_GFX_WOMAN_2_FRLG,           FACILITY_CLASS_LADY_FRLG,           FEMME}
};

static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_BEAUTY_FRLG,      OBJ_EVENT_GFX_WOMAN_1_FRLG,     FACILITY_CLASS_CRUSH_KIN_FRLG,    FEMME,  FEMME},
    {OBJ_EVENT_GFX_OLD_WOMAN_FRLG,   OBJ_EVENT_GFX_OLD_WOMAN_FRLG,   FACILITY_CLASS_OLD_COUPLE,        BUTCHY, FEMME},
    {OBJ_EVENT_GFX_LITTLE_GIRL_FRLG, OBJ_EVENT_GFX_LITTLE_GIRL_FRLG, FACILITY_CLASS_TWINS_FRLG,        FEMME,  FEMME},
    {OBJ_EVENT_GFX_COOLTRAINER_M,    OBJ_EVENT_GFX_COOLTRAINER_F,    FACILITY_CLASS_COOL_COUPLE_FRLG,  BUTCHY, FEMME},
    {OBJ_EVENT_GFX_BEAUTY_FRLG,      OBJ_EVENT_GFX_BEAUTY,           FACILITY_CLASS_YOUNG_COUPLE_FRLG, FEMME,  BUTCHY},
    {OBJ_EVENT_GFX_CRUSH_GIRL,       OBJ_EVENT_GFX_CRUSH_GIRL,       FACILITY_CLASS_CRUSH_KIN_FRLG,    FEMME,  BUTCHY},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND,   OBJ_EVENT_GFX_SWIMMER_F_LAND,   FACILITY_CLASS_SIS_AND_BRO_FRLG,  FEMME,  BUTCHY}
};
