...
static const u32 sSpinningPokenav_Pal[] = INCBIN_U16("graphics/pokenav/nav_icon.gbapal");
...
void PokenavCopyPalette(const u32 *src, const u32 *dest, int size, int a3, int a4, u32 *palette)
{
    if (a4 == 0)
    {
