...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("BRENDA");
...
const u8 gText_ThisIsAPokemon[] = _("Anyways,\nthis is what we call a “Threenis.”{PAUSE 96}\p");
const u8 gText_Butchy[] = _("Butchy");
const u8 gText_Femme[] = _("Femme");
...
const u8 gText_HelpfulTextLower1[] = _("Just give up you piece of shit!\n(to the POKéMON)");
...
const u8 gText_PokemonGotAway[] = _("Wowwww...\nThe POKéMON got away…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AnythingElseICanHelp[] = _("{SPEAKER SP_NAME_SHOP_CLERK}Is there anything else I can help\nyou with?");
...
const u8 gText_HealthboxGender_Male[] = _("{COLOR DYNAMIC_COLOR1}♂");
...
const u8 gText_Relearn_TM[] = _("{START_BUTTON} RELEARN TMHM");
...
const u8 gText_PokedexEncountersRemainingOneLeft[] = _("Still learning about this POKéMON.\n{STR_VAR_1} encounter left, you're so close!");
const u8 Roulette_Text_PlayMinimumWagerIsX[] = _("The minimum wager at this table\nis {STR_VAR_1}. Do you want to play?");
const u8 Roulette_Text_NotEnoughCoins[] = _("You don't have enough COINS.");
const u8 Roulette_Text_SpecialRateTable[] = _("Special rate table right now!");
const u8 Roulette_Text_ControlsInstruction[] = _("Place your wager with the + Control\nPad, then press the A Button.");
const u8 Roulette_Text_ItsAHit[] = _("It's a hit!");
const u8 Roulette_Text_Jackpot[] = _("Jackpot!");
const u8 Roulette_Text_NothingDoing[] = _("Nothing doing!");
const u8 Roulette_Text_YouveWonXCoins[] = _("You've won {STR_VAR_1} COINS!");
const u8 Roulette_Text_NoCoinsLeft[] = _("No COINS left…");
const u8 Roulette_Text_KeepPlaying[] = _("Keep playing?");
const u8 Roulette_Text_BoardWillBeCleared[] = _("The ROULETTE board will be cleared.");
const u8 Roulette_Text_CoinCaseIsFull[] = _("Your COIN CASE is full!\nCoins can be exchanged for prizes.");
