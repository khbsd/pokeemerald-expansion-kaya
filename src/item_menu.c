...
static void SortItemsInBag(enum Pocket pocket, u8 type);
...
static s8 CompareItemsByMost(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    ...
    u32 pocketPos1 = GetBagPocketPosition(gBagPosition.pocket, itemSlot1->itemId);
    u32 pocketPos2 = GetBagPocketPosition(gBagPosition.pocket, itemSlot2->itemId);

    u16 quantity1 = GetBagItemQuantity(pocketPos1, itemSlot1->quantity);
    u16 quantity2 = GetBagItemQuantity(pocketPos2, itemSlot2->quantity);
