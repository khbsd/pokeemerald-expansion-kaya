...
{
    u32 abilityPlayer = ABILITY_NONE, abilityOpponent = ABILITY_NONE;
    u32 speciesPlayer = SPECIES_NONE, speciesOpponent = SPECIES_NONE;

    u32 j;
    static const u32 moldBreakerAbilities[][2] = {
