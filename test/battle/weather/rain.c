...
SINGLE_BATTLE_TEST("Rain multiplies the power of Fire-type moves by 0.5x", s32 damage)
{
    u32 setupMove;
...
SINGLE_BATTLE_TEST("Rain multiplies the power of Water-type moves by 1.5x", s32 damage)
{
    u32 setupMove;
    PARAMETRIZE { setupMove = MOVE_CELEBRATE; }
    PARAMETRIZE { setupMove = MOVE_RAIN_DANCE; }
